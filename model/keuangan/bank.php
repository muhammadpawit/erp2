<?php
class ModelKeuanganBank extends Model {
  ...
  public function laporanmutasibank($bank_id,$data){
    $sql ="SELECT type,linkterkait,idref,no_dokumen,urlref,jurnal_id,id,date_added as tanggal_input,date_trans as tanggal_transaksi, saldomasuk,saldokeluar, keterangan, ref as referensi FROM aruskas WHERE bank_id='$bank_id' and hapus=0 ";
