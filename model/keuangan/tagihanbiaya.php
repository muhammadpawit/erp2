  ...
  public function addPembelian($data){
    ...
    */
    ...
    if($data['nominal'] > 0){
      ...
      //dokumen
      $dokumen=array(
        'nama_table'  => 'tagihan_biaya',
        'jurnal_id' => $idjurnal,
        'hapus' => 0,
        'id_transaksi'  => $id,
        'datakas' => 1,
        'id_mutasi' => 0,
        'jenis_transaksi' => 'Tagihan Biaya',
        'date_added'  => date('Y-m-d H:i:s')
      ...
      $no_dokumen='TB-'.$iddokumen;
      $this->db->update('no_dokumen',array('no_dokumen'=>$no_dokumen),array('id'=>$iddokumen));
      $this->db->update('tagihan_biaya',array('no_dokumen'=>$no_dokumen),array('id'=>$id));
