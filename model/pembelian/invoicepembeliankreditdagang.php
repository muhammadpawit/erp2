<?php
class ModelPembelianInvoicepembeliankreditdagang extends Model {
  /*
  1. ditagih
  2. belum lunas
  3. lunas
        ...
        */
        ...
        if($nilaipersediaan > 0){
          ...
          if($pb['diskon'] > 0){
            ...
            $pendapatan +=$diskoninv;
            $nilaibayar=$nilaibayar-$diskoninv;
          }

          $totalkiri=$nilaipersediaan+$beban+$debetpajak+$biayakirim;
          $totalkanan=$nilaibayar+$pendapatan+$kreditpajak;

          if($totalkiri < $totalkanan){
            $beban+=$totalkanan - $totalkiri;
          }

          if($totalkanan < $totalkiri){
            $pendapatan+=$totalkiri - $totalkanan;
          }
