...
class ModelPembelianInvoicepembelianimport extends Model {
	...
	public function getpemb($id){
		$d = $this->db->query("SELECT jpb.name, bp.total, bp.totalreal FROM biaya_pembelianimport bp LEFT JOIN jenis_biaya_pembelian jpb ON(jpb.id=bp.jenisbiaya_id) WHERE order_id='$id' ORDER BY bp.id DESC");
		return $d->rows;
	}
	// end baru
  /*
