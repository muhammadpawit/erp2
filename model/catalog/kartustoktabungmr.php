...
*/
class ModelCatalogKartustoktabungmr extends Model {
	public function addKartuStok($data){
		...
		*/
		$this->db->insert('kartustok_tabungmr',$kartustok);
	...
	public function getKartuStoks($data=array()){
		$sql="SELECT * FROM ".DB_PREFIX."kartustok_tabungmr WHERE tabung_id='".$data['tabung_id']."' ";
		if(!empty($data['type'])){
