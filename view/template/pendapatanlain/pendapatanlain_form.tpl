      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Input Pembulatan</h3>
              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table">
                    ...
                    <tr>
                       <td><span class="required">*</span>Tanggal Bayar/Terima</td>
                      ...
                      <tr>
                         ...
                         <td ><select name="type" class="form-control type">
                           <option value="1">Pendapatan Lain-lain</option>
                           <option value="2">Biaya Lain-lain</option>
                         </select>
                         </td>
                      </tr>
                      <tr id="hutanglain">
