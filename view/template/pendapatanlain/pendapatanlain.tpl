      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar Pembulatan</h3>
              ...
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <td><select name="filter_jenis" class="form-control">
                      ...
                      <option value="2">Pembayaran Tunai & COD</option>
                   		</select></td>
                ...
                <table class="table table-stripped">
                   ...
                   <!--  <td>
                    ...
                    <td><select name="filter_status" class="form-control">
                      <option value="0" <?php echo $filter_status=='0'?'selected':''?>>Semua Status</option>
                      <option value="1" <?php echo $filter_status==1?'selected':''?>>Disimpan</option>
                      <option value="2" <?php echo $filter_status==2?'selected':''?>>Diterima</option>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Total</label>
                  <?php
                    echo $this->currency->format($totals);
                  ?>
                </div>
              </div>
              <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['tgl_diterima']; ?></td>
                        ...
                        <td><?php
                          ...
                          if($product['metode_pembayaran'] == 5){
                            echo 'Dari Hutang lain';
                          }
                          if($product['metode_pembayaran'] ==6){
                            echo 'Biaya';
                          }
                          ?></td>
                          <td><?php echo $product['type']==1?'Pendapatan Lain-lain':'Biaya Lain-lain'; ?></td>
                      ...
                      <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>" <?php echo $action['newtarget']==1?'target="_blank"':''; ?> <?php echo $action['text']=='Cetak PO'?'target="_blank"':''; ?> class="badge bg-yellow"><?php echo $action['text']; ?></a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=keuangan/pendapatanlain&token=<?php echo $token; ?>';
