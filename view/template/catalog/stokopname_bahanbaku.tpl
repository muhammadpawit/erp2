                  ...
                  <table id="options" class="table table-stripped" style="max-width:550px;">
                      ...
                      <tr>
						          ...
						          <tr>
						              ...
						              <td>
						              		<input class="form-control" type="text" name="qty" value="<?php echo $productdesc['quantity']; ?>">

						              </td>
						          </tr>
                      <tr>
						              <td>Level Tercatat</td>
						              <td>
						              		<?php echo $productdesc['level']; ?>
						              </td>
						          </tr>
						          ...
						          <tr>
						              <td>Level Fisik</td>
						              <td>
						              		<input class="form-control" type="text" name="level" value="<?php echo $productdesc['level']; ?>">
