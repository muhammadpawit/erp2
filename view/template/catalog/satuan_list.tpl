                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data satuan tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-satuan').addClass('active');
</script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=catalog/satuan&token=<?php echo $token; ?>';
