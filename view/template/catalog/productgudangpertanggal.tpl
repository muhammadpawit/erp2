      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Stok Gudang Per-Tanggal</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tbody>
                    <tr>
                      <td><input type="text" name="date_start" value="<?php echo $filter_tanggal ?>" class="form-control" id="date-start"></td>
                      ...
                      <?php foreach ($products as $product) { ?>
                        ...
                        <tr>
                          ...
                          <td class="left"><?php echo $product['name']; ?></td>
                            ...
                            <?php } ?></td>
                          <!--<td><?php echo $product['net_cost'] ?></td>
                          <td><?php echo $product['total_netcost'] ?></td>-->
                          <td class="right"><?php foreach ($product['action'] as $action) { ?>
                             <a href="<?php echo $action['href']; ?>" class="badge bg-yellow"><?php echo $action['text']; ?></a><br>
                            <?php } ?></td>
                        </tr>
                        <?php //} ?> 
                      <?php } ?>
...
$('.sidebar-menu').find('#menu-produk-gudang-tgl').addClass('active');
...
function filter() {
	url = 'index.php?route=catalog/productgudang/stokpertanggal&token=<?php echo $token; ?>';
