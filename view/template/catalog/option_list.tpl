      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Ukuran Tabung</h3>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: center;">
                          ...
                          <input type="checkbox" name="selected[]" value="<?php echo $category['product_options_id']; ?>" checked="checked" />
                          <?php } else { ?>
                          <input type="checkbox" name="selected[]" value="<?php echo $category['product_options_id']; ?>" />
                          <?php }
                        //}
                        ?></td>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data ukuran tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-option').addClass('active');
</script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=catalog/options&token=<?php echo $token; ?>';
