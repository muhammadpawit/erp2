            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tbody>
                    <tr>
                      <td><input type="text" class="form-control" name="filter_no_tabung" value="<?php echo $filter_no_tabung; ?>" />
                        <td>
                      ...
                      <td>
                        <select class="select-ads" style="width:200px" name="filter_kelompok_aset" >
                          ...
                          foreach($asets as $u){
                          ?>
                            <option value="<?php echo $u['kelompok_aset_id']?>" <?php echo $u['kelompok_aset_id'] == $filter_kelompok_aset?'selected':''; ?>><?php echo $u['name']; ?></option>
                          <?php
                          }
                          ?>
                        </select>
                  ...
                  <td>
                      ...
                      <td><select name="filter_status" class="form-control">
                              ...
                              <option value="1" <?php echo $filter_status == 1?'selected':''; ?>>Tersedia (Terisi)</option>
                              ...
                              <option value="4" <?php echo $filter_status == 4?'selected':''; ?>>Tersedia (Kosong)</option>
                              <option value="5" <?php echo $filter_status == 5?'selected':''; ?>>Proses Produksi/Pengisian</option>
                              <option value="6" <?php echo $filter_status == 6?'selected':''; ?>>Dipinjam</option>
                              <option value="7" <?php echo $filter_status == 7?'selected':''; ?>>Dijual</option>
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="left">Nomor Tabung</th>
          				      <th class="left">Ukuran Tabung</th>
                        <th class="left">Jenis Gas</th>

                        <th class="left">Kelompok Aset</th>
                        <th class="right">Tanggal Pembeliaan</th>
                        <th>Harga Beli</th>
                        <th>Nilai</th>
                         <th class="left">Dipinjam Oleh</th>
                    ...
                    <tbody>
                      ...
                      <tr <?php echo $product['pemilik']==2?'style="background:#eee"':'';?>>
                        <td style="text-align: center;">
                    		<?php
                    		if($product['statuss'] == 4 | $product['statuss'] == 3){
                    		?>
                          ...
                          <td class="left"><?php echo $product['no_tabung']; ?></td>
                          <td class="left"><?php echo $product['ukurantabung']; ?></td>
                          <td class="left"><?php echo $product['customer']; ?>
                          </td>
                          <td class="left"><?php echo $product['kelompok_aset']; ?></td>
                          ...
                          <td class="left"><?php echo $product['peminjam']; ?></td>
...
function filter() {
	url = 'index.php?route=catalog/tabungmp&token=<?php echo $token; ?>';

	var filter_no_tabung = $('input[name=\'filter_no_tabung\']').val();

	if (filter_no_tabung) {
		url += '&filter_no_tabung=' + encodeURIComponent(filter_no_tabung);
	}
