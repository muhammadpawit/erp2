      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Kontak Vendor</h3>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="telephone" size="100" value="<?php echo $telephone; ?>" />
                        <input type="hidden" name="vendor_id" size="100" value="<?php echo $vendor_id; ?>" />
                        <input type="hidden" name="jenis" size="100" value="<?php echo $jenis; ?>" />
                        </td>
                    </tr>
