      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Tabung Milik Relasi (Pengisian Liquid)</h3>
...
function filter() {
	url = 'index.php?route=catalog/tabungmrbb&token=<?php echo $token; ?>';
...
$(function(){
  ...
  $(".lokasi-pameran").select2({
    ajax: {
    url:"index.php?route=catalog/bahanbaku/autocompleteprod&token=<?php echo $token; ?>",
    //url: "index.php?route=pamerantoko/toko/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
    data: function (params) {
      return {
