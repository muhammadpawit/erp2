      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Bahan Baku Produksi</h3>
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table id="options" class="table">
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="2"></td>
                        <td class="left"><a onclick="addOption();" class="btn btn-success">Tambah Bahan Baku</a></td>
                      </tr>
                    </tfoot>
                  </table>
                </form>
...
function addOption() {
	...
	html += '  <tr>';
    html += '    <td class="left"><select style="width:200px" class="select-ads" name="product_options[' + option_row + '][bahanbaku_id]">';
    <?php
    ...
    ?>
    html += '    </select></td>';
    html += '    <td class="right"><input type="text" class="form-control" name="product_options[' + option_row + '][jumlah]" value="0" /></td>';
...
function hapusoption(option_id){
  ...
  if(r){
    $.ajax({
			url: "index.php?route=catalog/product/hapusbahanbaku&token=<?php echo $token; ?>&product_id=<?php echo $this->request->get['product_id']; ?>&product_option_id="+option_id,
