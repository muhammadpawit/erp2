                ...
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td><select name="type" class="form-control">
                              ...
                              <option value="5" <?php echo $type == 5?'selected':'';?>>ATK Cacat</option>
                              <option value="6" <?php echo $type == 6?'selected':'';?>>ATK Hilang</option>
...
$('.sidebar-menu').find('#menu-persediaan-atk').addClass('active');
$(function(){
  $(".select-ads").select2({
