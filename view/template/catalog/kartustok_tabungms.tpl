                ...
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td><select name="type" class="form-control">
                              ...
                              <option value="1" <?php echo $type == 1?'selected':'';?>>Pengisian Produksi</option>
                              <option value="2" <?php echo $type == 2?'selected':'';?>>Penggembosan</option>
                              <option value="3" <?php echo $type == 3?'selected':'';?>>Penjualan</option>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="left"><?php echo $product['waktu']; ?></td>
          			          <td class="left"><?php echo $product['type'] == 1?'Pengisian':($product['type'] == 2?'Penggembosan':'Penjualan'); ?></td>
