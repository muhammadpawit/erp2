...
function hapusimage(product_image_id){
  var r=confirm("Anda yakin akan menghapus gambar? Gambar yang sudah dihapus tidak dapat dikembalikan lagi.");
  if(r){
    $.ajax({
			url: "index.php?route=catalog/product/hapusimage&token=<?php echo $token; ?>&product_image_id="+product_image_id,
