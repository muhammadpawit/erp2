                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><select class="form-control" name="filter_country_id">
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data kabupaten/kota tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-kabupaten').addClass('active');
</script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=catalog/kabupaten&token=<?php echo $token; ?>';
