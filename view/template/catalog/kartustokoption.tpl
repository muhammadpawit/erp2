              ...
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="kartuukuran" class="form-control">
                          <option value="*">Tampil Semua</urutkan>
                          <?php
                          foreach($productoption as $p){
                          ?>
                            <option value="<?php echo $p['product_option_id']; ?>" <?php echo $p['product_option_id'] == $kartuukuran?'selected':'';?>><?php echo $p['name'];?></option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <td><select name="type" class="form-control">
                              ...
                              <option value="3" <?php echo $type == 3?'selected':'';?>>Transfer</option>
                              <option value="4" <?php echo $type == 4?'selected':'';?>>Terima Transfer</option>
                              <option value="5" <?php echo $type == 5?'selected':'';?>>Pengiriman Toko</option>
                              <option value="6" <?php echo $type == 6?'selected':'';?>>Pengiriman Pameran</option>
                              <option value="7" <?php echo $type == 7?'selected':'';?>>Retur Toko</option>
                              <option value="8" <?php echo $type == 8?'selected':'';?>>Retur Pameran</option>
                              <option value="9" <?php echo $type == 9?'selected':'';?>>Stok Opname</option>
                              <option value="10" <?php echo $type == 10?'selected':'';?>>Set Stok Awal</option>
                              <option value="11" <?php echo $type == 11?'selected':'';?>>Produk Cacat</option>
                              <option value="12" <?php echo $type == 12?'selected':'';?>>Produk Hilang</option>
                              <option value="13" <?php echo $type == 13?'selected':'';?>>Retur Penjualan</option>
                              <option value="14" <?php echo $type == 14?'selected':'';?>>Retur Pembelian</option>
                            </select>
                      </td>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="left"><?php echo $product['option']; ?></td>
          			          <td class="left"><?php echo $product['type']; ?></td>
                          <td class="left"><?php echo $product['invoice']; ?></td>
...
$('.sidebar-menu').find('#menu-stok-gudang').addClass('active');
...
function filter() {
  ...
  var kartuukuran = $('select[name=\'kartuukuran\']').val();

	if (kartuukuran != '*') {
		url += '&kartuukuran=' + kartuukuran;
	}
