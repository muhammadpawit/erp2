      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Deposit Vendor Lokal</h3>
            <div class="button pull-right">
                  <a onclick="location = '<?php echo $insert; ?>'" class="btn btn-info">Tambah</a>
                  <a onclick="location = '<?php echo $inserthistory; ?>'" class="btn btn-primary">Tambah Riwayat Transaksi</a>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="left"><a href="<?php echo $customer['urlref']; ?>" target="_blank"><?php echo $customer['no_dokumen']; ?></a></td>
