                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="5">Data vendor tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
function filter() {
	...
	var filter_name_contact = $('input[name=\'filter_name\']').val();

	if (filter_name_contact) {
		url += '&filter_name_contact=' + encodeURIComponent(filter_name_contact);
	}
