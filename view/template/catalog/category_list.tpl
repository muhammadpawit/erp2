      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Kategori Produk Dagang</h3>
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="left">Kategori Utama</th>
                        <th class="right"></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="left"><?php echo $category['parent']; ?></td>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data kategori tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-kategori').addClass('active');
</script>
<?php echo $footer; ?>
