            ...
            <div class="row">
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table">
                    <tr>
                      <td><span class="required">*</span> Nomor Tabung</td>
                      <td><input type="text" class="form-control" name="no_tabung" size="100" value="<?php echo $no_tabung; ?>" <?php echo isset($this->request->get['id'])?'':''; ?> />
                      </td>
                    </tr>
                    <tr>
                      <td>Kelompok Aset</td>
                      <td>
                          <select class="form-control" name="kelompok_aset">
                          <?php
                          foreach($asets as $c){
                          ?>
                            <option value="<?php echo $c['kelompok_aset_id']; ?>" <?php echo $c['kelompok_aset_id']==$kelompok_aset?'selected':''; ?>><?php echo $c['name']; ?></option>
                          <?php
                          }
                          ?>
                          </select>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><select class="form-control status" name="status">
                            ...
                            <option value="8" <?php echo $status == 8?'selected':''; ?>>Rusak</option>
