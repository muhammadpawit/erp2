              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-stripped">
                    ...
                    <tr>
                      <td>Alamat</td>
                      <td><input type="text" name="alamat" size="100" value="<?php echo $alamat; ?>" />
                        </td>
                    </tr>
                    <tr>
                      <td>Tax ID</td>
                      <td><input type="text" name="npwp" size="100" value="<?php echo $npwp; ?>" />
                        </td>
                    </tr>
                    <tr>
                      <td>Telephone</td>
                      <td><input type="text" name="telephone" size="100" value="<?php echo $telephone; ?>" />
                        </td>
                    </tr>
                    </table>
                </form>
...
$('.sidebar-menu').find('#menu-vendor-import').addClass('active');
</script>
