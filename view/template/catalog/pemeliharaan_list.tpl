      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Jenis Pemeliharaan Aset</h3>
                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data jenis pemeliharaan tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-pemeliharaan').addClass('active');
</script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=catalog/pemeliharaan&token=<?php echo $token; ?>';
