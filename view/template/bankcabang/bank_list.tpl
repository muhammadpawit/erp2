      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Bank Kas Cab.Surabaya</h3>
...
$(function(){
  $(".lokasi-pameran").select2({
    ajax: {
    url: 'index.php?route=keuangan/bankcabang/autocomplete&token=<?php echo $token; ?>',
    dataType: 'json',
...
function filter() {
	url = 'index.php?route=keuangan/bankcabang&token=<?php echo $token; ?>';
