                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <a onclick="detail('<?php echo $product['invoice'] ?>')" data-toggle="modal" data-target="#jurnal"><?php echo empty($product['linkterkait'])?$product['invoice']:$product['invoice']; ?></a>
                        <?php }else{ ?>
                        ...
                        <td class="left">
                        <?php if($product['invoice']>=3000) { ?>
                        <a onclick="detail('<?php echo $product['invoice'] ?>')" data-toggle="modal" data-target="#jurnal"><?php echo empty($product['linkterkait'])?'':$product['linkterkait']; ?></a>
                        <?php }else{ ?>
