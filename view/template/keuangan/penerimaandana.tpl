              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <?php
                    ...
                    echo $this->currency->format($total);
                  ?>
                </div>
              </div>
              <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['tglterima_giro']; ?></td>
                        ...
                        <td><?php
                          ...
                          <td><?php echo $product['pendapatan']; ?></td>
                          <td>
                            <?php
                              if($product['status'] == 1){
                                echo 'Disimpan';
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=keuangan/penerimaandana&token=<?php echo $token; ?>';
