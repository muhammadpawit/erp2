              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" name="linkterkait" />
                     </td>
                  </tr>
                  ...
                  <tr id="ref-debet">
                     ...
                     <td colspan="2" >
                       ...
                       <!--<select name="ref_debet" class="form-control">
                        <option value="<?php echo $bank['rek_parent']; ?>"><?php echo $bank['rek_parent']; ?> <?php echo $bank['name']; ?></option>
                       </select>-->
                     </td>
                   </tr>
                   <tr id="ref-kredit">
                      ...
                      <td colspan="2" >
                        ...
                        <!--<select name="ref_kredit" class="form-control">
                        <option value="<?php echo $bank['rek_parent']; ?>"><?php echo $bank['rek_parent']; ?> <?php echo $bank['name']; ?></option>
                       </select>-->
                      </td>
                    </tr>
