                    ...
                    <tbody>
                      ...
                      <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['newtarget']==1?'target="_blank"':''; ?> class="badge bg-yellow"><?php echo $action['text']; ?></a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=keuangan/pembayarantagihan&token=<?php echo $token; ?>';
