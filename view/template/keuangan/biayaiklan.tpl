                ...
                <table class="table table-stripped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $p['jenis']; ?>
                      ...
                      if($p['masaberlaku'] > 1){
                      ?>
                      Untuk pembayaran selama <?php echo $p['masaberlaku']; ?> Bulan
                      <?php
                      }
                      ?>
                    </small>
...
function filter() {
	url = 'index.php?route=keuangan/biayaiklan&token=<?php echo $token; ?>';
...
$(document).ready(function() {
  ...
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=keuangan/biayaiklan/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
...
$(".lokasi-pameran").select2({
  ajax: {
  url: 'index.php?route=keuangan/vendoriklan/autocomplete&token=<?php echo $token; ?>',
  dataType: 'json',
  data: function (params) {
    return {
  ...
  processResults: function (data) {
    return {
      //data.push({id:0,text:'Tanpa Vendor'})
      results: data
    };
  },
  //cache: true
