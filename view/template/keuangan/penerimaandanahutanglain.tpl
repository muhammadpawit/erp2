                    ...
                    <tbody>
                      ...
                      <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['text']=='Cetak PO' | $action['text'] == 'Lihat Jurnal'?'target="_blank"':''; ?> class="badge bg-yellow"><?php echo $action['text']; ?></a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
$('.sidebar-menu').find('#menu-menerimaan-dana').addClass('active');
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=keuangan/penerimaandanahutanglain&token=<?php echo $token; ?>';
