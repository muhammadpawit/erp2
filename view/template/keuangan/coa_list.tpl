      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Chart Of Account (COA)</h3>
            <div class="button pull-right">
									<a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Tambah</button></a>
                  <a href="<?php echo $saldoawal; ?>"><button type="button" class="btn btn-success">Saldo Awal</button></a>
...
<script>
function filter(){
  url = 'index.php?route=keuangan/coa&token=<?php echo $token; ?>';
