                      ...
                      <tr>
                        ...
                        <td class="right"><?php foreach ($product['action'] as $action) { ?>
                          ...
                          <?php if($product['stat']==0){?>
                            ...
                            <!-- <a onclick="PopupCenter('<?php echo $view; ?>','view',500,500)" class="label label-primary">Proses</a> -->
                          <?php }?>
                        </td>
                      </tr>
                      <?php } ?>
  ...
  //$("#id").html(id);
    $.ajax({
      ...
      success: function(json) {
        ...
        // console.log(json);
        // $("input:hidden").val(json.id);
        // $('input[name=\'gudang_id\']').val(json.gudang_id);
        // $('input[name=\'qtyperakitan\']').val(json.qty);
        // $('input[name=\'product_id\']').val(json.product_id);
        // $('input[name=\'nama_product\']').val(json.nama_product);
        // $("#nama_product").html(json.nama_product);
        // $("#qty").html(json.qty);
        // console.log(json.products);
        // $.each(json.products, function(k, v) {
        //     markup =  "<tr>";
        //     markup += "<td>" + v.product_name + "</td>";
        //     // markup += "<td>" + v.quantity + "</td>";
        //     markup += "</tr>";
        //     $("#tbody").before(markup);
        // });
