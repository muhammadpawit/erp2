      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Informasi Perakitan Produk</h3>
            <div class="button pull-right">              
                <!-- <a onclick="window.close()"><button type="button" class="btn btn-danger">Kembali</button></a> -->
          ...
          <div class="box-body">
            ...
            <div class="row">
                  ...
                  <table class="table" border="1">
                     ...
                     <tr>
                      ...
                      <tr>
                          <td>Tanggal</td>
                          <td>
                            <?php echo date('d/m/Y',strtotime($products['tanggal_perakitan'])) ?>
                          </td>
                      </tr>
                      <tr>
                        <td>Nama Produk Hasil</td>
                        <td>
                          <?php echo $products['nama_product'] ?>
                        </td>
                      </tr>
                      <tr>
                        <td>Qty</td>
                ...
                <div class="col-md-6">
                  <div class="panel panel-success">
                    <div class="panel-heading">Komponen Produk</div>
                    <div class="panel-body">
                      <table class="table" border="1">
                        <?php foreach($kproducts as $p ) { ?>
                          <tr>
            ...
            <br>Apakah anda yakin akan memproses perakitan ini?<br>
          </div>
          <div class="box-footer">
            <div class="row">
              <div class="col-md-12">
                <a onclick="window.close()"><button type="button" class="btn btn-danger">Ya</button></a>
                <a onclick="window.close()"><button type="button" class="btn btn-danger">Tidak</button></a>
              </div>
            </div>
          </div>
        </div>
...
function addModule() {
  ...
  html += '    <td class="right"><input type="hidden" class="form-control" name="product[' + product_row + '][product_name]" /><input type="hidden" class="form-control" name="product[' + product_row + '][quantity]" onblur="updatetotal('+product_row+')" value="'+ qty +'" /></td>';
  html += '</tbody>';
