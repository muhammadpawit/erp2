                    ...
                    <!--td>
                      ...
                      <td>
                          <select class="form-control" name="filter_status">
                            ...
                            <option value="1" <?php echo $filter_status == 1?'selected':''; ?>>Menunggu</option>
                            <option value="2" <?php echo $filter_status == 2?'selected':''; ?>>Proses Produksi</option>
                            <option value="4" <?php echo $filter_status == 4?'selected':''; ?>>Partial</option>
                            <option value="5" <?php echo $filter_status == 5?'selected':''; ?>>Produksi Selesai</option>
                          </status>
                      </td-->
                ...
                <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>Gudang</th>
                        <th>Jenis Produksi</th>
                        <th>Nomor<br>Permintaan Produksi</th>
                        <th>Nama Produk</th>
                        <th>Ukuran Tabung</th>
                        <th>Qty Proses</th>
                        <th>Qty Hasil</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo $product['urlpermintaan'];?>" target="_blank" ><?php echo $product['permintaan'];?></a></td>
                        <td><?php echo $product['namaproduk']; ?></td>
                        <td><?php echo $product['ukuran']; ?></td>
                        <td><?php echo $product['quantityproses']; ?></td>
                        <td><?php echo $product['quantityhasil']; ?></td>
                        <!--td>
                          <?php
                            if($product['status'] == 3){
                              echo 'Dibatalkan';
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=produksi/hasilproduksi&token=<?php echo $token; ?>';
