              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td> Edit (Supir dan Kernet) Surat Jalan
                        <input type="hidden" value="10" name="user_menu[10][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[10][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[10]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[10]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Setting Limit Tagihan
                        <input type="hidden" value="11" name="user_menu[11][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[11][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[11]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[11]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Pembatalan Perakitan
                        <input type="hidden" value="12" name="user_menu[12][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[12][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[12]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[12]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Tutup SO yang dikirim sebagian
                        <input type="hidden" value="13" name="user_menu[13][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[13][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[13]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[13]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Set Harga Terendah
                        <input type="hidden" value="14" name="user_menu[14][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[14][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[14]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[14]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Persetujuan Tanggal SO
                        <input type="hidden" value="15" name="user_menu[15][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[15][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[15]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[15]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Persetujuan Harga SO
                        <input type="hidden" value="16" name="user_menu[16][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[16][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[16]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[16]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td> Export to Excel Kartustok Produk
                        <input type="hidden" value="17" name="user_menu[17][akses]" >
                      </td>
                      <td>
                        <select class="form-control" name="user_menu[17][nilai]">
                          <option value="0" >Belum Diatur</option>
                          <option value="1" <?php echo $user_menu[17]['nilai'] == 1?'selected':''; ?>>Ya</option>
                          <option value="2" <?php echo $user_menu[17]['nilai'] == 2?'selected':''; ?>>Tidak</option>
                        </select>
                      </td>
                    </tr>
                    </tbody>
