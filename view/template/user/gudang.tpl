      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Akses Gudang</h3>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="scrollbox" style="height:200px;overflow:scroll">
                          <?php $class = 'odd'; ?>
                          <?php foreach ($gudangs as $category) { ?>
                          <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                          <div class="<?php echo $class; ?>">
                            <?php if (in_array($category['gudang_id'], $gudang)) { ?>
                            <input type="checkbox" name="gudang[]" value="<?php echo $category['gudang_id']; ?>" checked="checked" />
                            <?php echo $category['nama']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="gudang[]" value="<?php echo $category['gudang_id']; ?>" />
                            <?php echo $category['nama']; ?>
                            <?php } ?>
                          </div>
                          <?php } ?>
