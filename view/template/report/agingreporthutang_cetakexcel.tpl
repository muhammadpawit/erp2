<?php
if($this->user->getUsername()=="spawit"){
	
}else{
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=aging-hutang.xls");
}
?>
...
<div id="content">
  ...
  <h2>Aging Hutang <?php echo $this->config->get('config_name'); ?> Gudang <?php echo $gudang ?></h2>

  <h3>Tanggal Cetak</b> <?php echo date('d F Y',time()); ?> oleh <?php echo $this->user->getUsername()?></h3>
 ...
 <table class="store">
	 <table class="table table-bordered">
         ...
         <th style="width:5%">
				 ...
				 <th style="width:5%">0-15</th>
				 <th style="width:5%">16-30</th>
		 ...
		 <tbody>
			 ...
			 <tr class="invoice" data-id="<?php echo $product['customer_id']; ?>" data-faktur="<?php echo $product['name']; ?>" id="list-invoice-<?php echo $product['id']; ?>" >
				 ...
				 <td style="background-color:#ccc" ></td>
				 <td style="background-color:#ccc" ><?php echo $product['sisabayar15']; ?></td>
			 ...
			 <tr>
				 ...
				 <td style="background-color:#ccc" ></td>
				 <td style="background-color:#ccc" ><b><?php echo $jumlah15; ?></b></td>
