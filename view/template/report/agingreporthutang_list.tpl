              ...
              <div class="col-md-4 col-xs-12">
                <table class="table table-stripped">
                  <tr>
                    <td>Vendor</td>
                    <td>
                    <select name="filter_customer_id" class="form-control vendor">
                      <option value="*" <?php echo empty($filter_customer_id)?'selected':'';?>>Semua </option>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo $cetak?>" class="btn btn-success">Cetak</a></td>
                  </tr>
              ...
              <div class="col-md-8 col-xs-12" style="max-height:300px;overflow-y:scroll">
                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                      ...
                      <tr>
                        <th class="left">
                          <?php if ($sort == 'customer.name') { ?>
                            ...
                            <?php } else { ?>
                            <a href="<?php echo $sort_customer; ?>">Nama Vendor</a>
                            <?php } ?>
                        </th>
                  ...
                  ">
                        ...
                        <!--<td><?php echo $product['followup']; ?></td>
              ...
              <div class="col-xs-12 table-responsive" >
                ...
                <table class="table table-bordered">
                  ...
                  <tbody class="list-product" id="list<?php echo $p['customer_id']; ?>">
                    ...
                    ?>
                    <?php if(round($tagihan)>0){?>
                    <tr >
                      <td><a target="_blank" href="<?php echo $this->url->link('pembelian/invoicepembeliandagang/tampil', 'token=' . $this->session->data['token'].'&view=1&id='.$product['id'], 'SSL'); ?>"><?php echo $product['no_faktur']; ?></a></td>
...
function filter() {
	url = "index.php?route=laporan/aginghutang&token=<?php echo $token; ?>";
