      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Jurnal Memo</h3>
            <div class="button pull-right">            
              <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Input Jurnal</button></a>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=laporan/jurnalmanual&token=<?php echo $token; ?>';
