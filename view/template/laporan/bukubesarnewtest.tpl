      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Buku Besarx</h3>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php if ($orders){ ?>
                        ...
                        ?>
                            <tr>
                              <td><b><?php echo $awal ?></b></td>
                              <td>-</td>
                              <td>Saldo Awal Coa</td>
                              <td align="right"><?php echo $this->currency->format($saldoawalcoa)?></td>
                      ...
                      <?php
                            if($a==0){
                              $sisa += ($saldoawalcoa+$d['debet']-$d['kredit']);
                            }else{
                      ...
                      <tr>
                        ...
                        <td align="right">
                          <?php echo $this->currency->format($sblm+$debet-$kredit) ?>
                        </td>
                      </tr>
                      <?php }?>
                      <?php
                      ...
                      <tr>
                        ...
                        <td><?php echo $this->currency->format($sblm); ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo $this->currency->format($sblm+$debet-$kredit); ?></td>
                      </tr>
                      <?php } else { ?>
                      <tr>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=keuangan/bukubesar/baru&token=<?php echo $token; ?>&downloadexcel=1';
