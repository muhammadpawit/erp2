      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Laporan Pemeliharaan Aset</h3>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="select-ads" style="width:200px" name="filter_kelompok_aset" >
                          ...
                          foreach($asets as $u){
                          ?>
                            <option value="<?php echo $u['id']?>" <?php echo $u['id'] == $filter_kelompok_aset?'selected':''; ?>><?php echo $u['name']; ?></option>
                          <?php
                          }
                          ?>
                        </select>
                  ...
                  <table class="table table-bordered">
                    <thead>
                      ...
                      <th class="left">Tanggal</th>
                        <th class="left">Nama Aset</th>
                        <th class="left">Jenis Pemeliharaan</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td class="left"><?php echo $product['tanggal']; ?></td>
                          <td class="left"><?php echo $product['name']; ?></td>
                            <td class="left"><?php echo $product['pemeliharaanname']; ?></td>
                      <td class="left"><?php echo $product['biaya']; ?></td>
                      <td class="left"><?php echo $product['totalbayar']; ?></td>
...
$('.sidebar-menu').find('#menu-laporan-pemeliharaan-asset').addClass('active');
$(function(){
  $(".select-ads").select2({
...
function filter() {
	url = 'index.php?route=laporan/pemeliharaanaset&token=<?php echo $token; ?>';
