      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Laporan Hutang</h3>
              ...
              <div class="col-md-4">
                <table class="table table-stripped">
                    <thead>
                      ...
                      <tr>
                        <td></td>
                        <td><a onclick="filter();" class="btn btn-info"><i class="fa fa-filter"></i>&nbsp;Filter</a></td>
                      </tr>
                    </thead>
                    <tbody>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=laporan/hutang&token=<?php echo $token; ?>';
...
$(document).ready(function() {
  ...
  url = 'index.php?route=laporan/hutang/serversidebaru&token=<?php echo $token; ?>';
  ...
  var filter_vendor ='<?php echo $filter_vendor?>';
