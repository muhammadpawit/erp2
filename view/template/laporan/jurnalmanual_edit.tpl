      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Jurnal Memo <?php echo $jurnal['keterangan']; ?></h3>
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table">
                    ...
                    <tr>
                     ...
                     <input type="hidden" name="jurnal_umum" class="form-control" value="<?php echo $jurnal['jurnal_umum']; ?>" readonly >
                     </td>
                   </tr>
                   <tr>
                    ...
                    <table class="table table-bordered"  id="list-product">
                      ...
                      <tbody id="product-row<?php echo $i; ?>">
                        ...
                        <tr>
                          <td>
                          <?php 
                          echo $d['ref_akun'].' '.$d['keterangan'];
                          ?>
                          <input type="hidden" readonly class="form-control" name="detail[<?php echo $i; ?>][ref_akun]" value="<?php echo $d['ref_akun'];?>"><input type="hidden" class="form-control" name="detail[<?php echo $i; ?>][id]" value="<?php echo $d['id'];?>"></td>
                          <td>
                            <input type="hidden" class="form-control" name="detail[<?php echo $i; ?>][customer_id]" value="<?php echo $d['customer_id'];?>">
                            <?php 
                            if($d['customer_id'] > 0){
                              $cust=$this->model_sale_customer->getVendor(array('customer_id'	=> $d['customer_id']));
                              echo $cust['name'];
                            }
                          ...
                          <td>
                            <input type="hidden" class="form-control" name="detail[<?php echo $i; ?>][vendor_id]" value="<?php echo $d['vendor_id'];?>">
                             <?php 
                              if($d['vendor_id'] > 0){
                                $vendor=$this->model_catalog_vendorlokal->getVendor(array('id'	=> $d['vendor_id']));
                                echo $vendor['name'];
                              }
                             
                              ?>
                          </td>
                          <td><input type="text" class="form-control" onblur="updateTotal()" name="detail[<?php echo $i; ?>][debet]" value="<?php echo $d['debet'];?>">
                          <input type="hidden" class="form-control" name="detail[<?php echo $i; ?>][debetlama]" value="<?php echo $d['debet'];?>">
                          </td>
                          <td><input type="text" class="form-control" onblur="updateTotal()" name="detail[<?php echo $i; ?>][kredit]" value="<?php echo $d['kredit'];?>">
                          <input type="hidden" class="form-control" name="detail[<?php echo $i; ?>][kreditlama]" value="<?php echo $d['kredit'];?>">
                          </td>
...
function addModule() {
  ...
  html += '<td class="left"><select style="width:150px" name="detail[' + product_row + '][ref_akun]" class="form-control coa"></select></td>';
