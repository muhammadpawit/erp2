      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Laporan Barang Datang Pembelian Produk Dagang</h3>
...
$('.sidebar-menu').find('#menu-laporan-pembelian-lokal').addClass('active');
function detail(id){
    $.ajax({
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=laporan/pembelianlokal&token=<?php echo $token; ?>';
