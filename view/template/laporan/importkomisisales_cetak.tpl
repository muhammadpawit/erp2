                    ...
                    <tbody>
                        ...
                        <?php
                          ...
                          <tr style="background-color:#e3fbfc">
                              ...
                              <td><?php echo ($th) ; ?></td>
                              <td><?php echo ($p['total']-$th) ; ?></td>
                              <td><?php echo ($p['bkirim']);?></td>
                              <td><?php echo ($biayabungakredit);?></td>
                              <td></td>
                              <td></td>
                              ...
                              <tr>
                                ...
                                <td><?php echo $pr['hargasatuan']?></td>
                                <td></td>
                                <td><?php echo $pr['harga_terendah']?></td>
                                <td>0</td>
                        ...
                        <?php } ?>
                          <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><?php echo $totalpoin?></td>
                            <td></td>
                            <td><?php echo $allivs ?></td>
                            <td><?php echo $allih ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
