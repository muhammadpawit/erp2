...
header("Content-Disposition: attachment; filename=Jurnal_Umum_Nisson_".date('d-F-Y',strtotime($_REQUEST['filter_date_start']))."_s/d_".date('d-F-Y',strtotime($_REQUEST['filter_date_end'])).".xls");
?>
