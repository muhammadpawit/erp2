              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table">
                    ...
                    <tr>
                       <td><span class="required">*</span>No. Faktur Pembelian Import</td>
                     ...
                     <tr>
                         <td>Jumlah</td>
                         <td><input type="text" name="nominal" class="form-control" value="0" ><input readonly type="hidden" name="sisatagihan" class="form-control" value="0" >
...
$(document).ready(function() {
  ...
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/invoicepembelianimport/autocompletepib&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
  ...
  theme:"bootstrap"
    ...
    if(id != undefined & id != null){
      ...
      invoice=$(".invoice").val();
    $.ajax({
      url: 'index.php?route=pembelian/invoicepembelianimport/detailpib&token=<?php echo $this->request->get['token']; ?>&id='+id,
      dataType: 'json',
      success: function(json) {
        if(json){
          ...
          rincian='';
          /*rincian +=" PPn: "+json.ppnpib+"<br>";
          rincian +=" PPh Pasal 22: "+json.pphpib+"<br>";
          rincian +=" BM: "+json.bmpib+"<br>";*/
          rincian +=" Total: "+json.totalpib+"<br>";
          rincian +=" Telah Dibayar: "+json.totalbayar+"<br>";
          rincian +=" Sisa Tagihan: "+json.sisa+"<br>";

          $("#no-pib").html(json.no_pib);
          $("#ppn").html(json.ppnpib);
          $("#pph").html(json.pphpib);
          $("#bm").html(json.bmpib);
          $("#rincian-pib").html(rincian);
          $("input[name='sisatagihan']").val(json.plainsisa);
          $("input[name='nominal']").val(json.plainsisa);
...
function simpan(){
  ...
  if($("input[name='nominal']").val() == null | $("input[name='nominal']").val() == ""){
    ...
    if(Number(nominal) > $("input[name='sisatagihan']").val()){
      error=true;
