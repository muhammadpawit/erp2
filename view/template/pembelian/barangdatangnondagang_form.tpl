              ...
              <div class="col-md-12">
                ...
                <table class="table">
                  ...
                  <tr>
                      ...
                      <td><input class="date form-control" type="text" required name="tgl_terima" readonly value="<?php echo $permintaan['tglfaktur']; ?>"></td>
                  </tr>
                  <tr>
                     <td>Akun Aktiva</td>
                     <td >
                  ...
                  <tr>
                     ...
                     <td>
                       ...
                       <input class="form-control" type="hidden" name="penerima" value="">
                       <input class="form-control" type="hidden" name="pengangkut_id" value="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if($sisa > 0){
                          ?>
                            <input class="form-control" type="text" name="products[<?php echo $i; ?>][quantityterima]" readonly value="<?php echo $sisa;?>">
                          <?php
                        }else{
                          ?>
