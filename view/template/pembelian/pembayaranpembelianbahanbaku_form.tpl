      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Alokasi Pembayaran Pembelian Bahan Baku</h3>
...
html += '    <td class="right"><input class="form-control" onblur="updatetotal()" type="text" name="orders[' + product_row + '][total]" /></td>';
  ...
  $(document).ready(function() {
    ...
    $(".nosurat").select2({
      ajax: {
      url:"index.php?route=pembelian/invoicepembelianbahanbaku/autocompletepembayaran&token=<?php echo $this->request->get['token']; ?>",
      dataType: 'json',
    ...
    theme:"bootstrap"
      ...
      $.ajax({
        url: 'index.php?route=pembelian/invoicepembelianbahanbaku/detail&token=<?php echo $this->request->get['token']; ?>&id=' + id,
        dataType: 'json',
