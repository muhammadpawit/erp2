      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Buat Invoice Pembelian Lokal</h3>
                ...
                <div class="col-sm-6 col-xs-12">
                  <table class="table table-responsive" >
                    ...
                    <tr id="biaya-kirim">
                      <td>Biaya Kirim</td>
                      <td>
                        <input type="text" class="form-control" name="biayakirim" value="0">
...
$(document).ready(function() {
  ...
  theme:"bootstrap"
    ...
    $.ajax({
      url: 'index.php?route=pembelian/pembeliankredit/detail&token=<?php echo $this->request->get['token']; ?>&vendor_id=' + id+'&jenisbarang='+jenisproduk+'&gudang_id='+gudang_id,
      dataType: 'json',
...
//  alert('ok');
  ...
  biayakirim=Number($("#biaya-kirim").val());
  dp=Number($("#dp").val());
  pajak=0;
  grandtotal=0;
  totalpembulatan=0;
  ...
  $("#diskon").val(diskon);
    ...
    $("#totalpo").val(totalpo+biayakirim);
