      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Pembayaran Pembelian Non Produk Dagang Lokal</h3>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if($p['status'] == 1){
                      ?>
                      <a href="<?php echo $this->url->link('pembelian/pembayaranpembeliannondagang/batalkan', 'token=' . $this->session->data['token'] . $url.'&id='.$p['id'], 'SSL'); ?>"  class="badge bg-red">Batalkan</a>
                      <?php
                        }else{
