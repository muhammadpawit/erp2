                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if($p['status'] == 1){
                      ?>
                      <a href="<?php echo $this->url->link('pembelian/pembayaranpembeliandagang/batalkan', 'token=' . $this->session->data['token'] . $url.'&id='.$p['id'], 'SSL'); ?>"  class="badge bg-red">Batalkan</a>
                      <?php
                        }else{
