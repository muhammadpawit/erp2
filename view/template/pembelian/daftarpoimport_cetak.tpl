    ...
    <div class="row page-header">
      ...
      <div class="col-xs-9 col-sm-10">
        <address>
          ...
          <h1><strong><?php echo $this->config->get('config_name'); ?></strong></h1>
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
           Purchased Order<br>
           <small>PO Number: <?php echo $permintaan['no_po']; ?></small>
           <small>PO Date: <?php echo date('d F Y',strtotime($permintaan['date_added'])) ?></small>
