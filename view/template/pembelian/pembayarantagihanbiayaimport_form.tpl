      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Pembayaran Tagihan Biaya Pembelian Import</h3>
...
$(document).ready(function() {
  ...
  theme:"bootstrap"
    ...
    if(id != undefined & id != null){
      ...
      invoice=$(".invoice").val();
    $.ajax({
      url: 'index.php?route=pembelian/tagihanbiayaimport/detailbiaya&token=<?php echo $this->request->get['token']; ?>&id='+id,
      dataType: 'json',
