                      ...
                      <tr>
                        ...
                        <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['text']=='Cetak PO'?'target="_blank"':''; ?> class="badge <?php echo $action['text']=='Setujui Perubahan Harga'?'bg-yellow':($action['text']=='Tolak Perubahan Harga'?'bg-red':'bg-blue'); ?>"><?php echo $action['text']; ?></a><br>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
$(function(){
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/invoicepembelianbahanbaku/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/invoicepembelianbahanbaku&token=<?php echo $token; ?>';
