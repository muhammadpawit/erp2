               ...
               <tr>
                ...
                <table class="table">
                    <thead>
                      ...
                      <th class="text-center">Quantity<br>(Kg)</th>
                      <th class="text-center">Quantity Telah Diterima<br>(Kg)</th>
                      <th class="text-center">Quantity Datang<br>(Kg)</th>
                      <?php
                      if($permintaan['jenis_barang'] == 1){
                      ?>
                      <th class="text-center">Level Awal</th>
                      <th class="text-center">Level Akhir</th>
                      <?php
                      }
                      ?>
                    </tr>
