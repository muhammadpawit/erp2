              ...
              <div class="col-xs-12 col-md-6">
                ...
                <div class="col-xs-12 col-md-6">
                  <table class="table">
                       ...
                       <tr>
                           <td>Sub Total</td>
                           <td colspan="2"><input type="text" readonly name="nominal" class="form-control" value="0" >&nbsp;<small><span id="subtot"></span></small></td>
                       </tr>
                       ...
                       <tr>
                           <td>Total Pajak</td>
                           <td colspan="2"><input type="text" onblur="updatetotal()" name="nilaipajak" class="form-control" value="<?php echo $nilaipajak; ?>" >
                            &nbsp;<small><span id="subtot"></span></small>
                           </td>
                       </tr>
                       ...
                       <tr>
                           ...
                           <td colspan="2"><input type="text" name="ppns" onblur="updatetotal()" class="form-control" value="0" >&nbsp;<small><span id="tppns"></span></small></td>
                       </tr>
					             <tr>
                           <td>Total Ppn</td>
                           <td colspan="2"><input type="text" name="ppn" onblur="updatetotal()" class="form-control" value="0" >&nbsp;<small><span id="tppn"></span></small></td>
                       </tr>
                       <tr>
                           <td>Total Tagihan</td>
                           <td colspan="2"><input type="text" onblur="updatetotal()" readonly name="total" class="form-control" value="0" >&nbsp;<small><span id="ttagihan"></span></small></td>
                       </tr>
                       <tr>
                           <td>Total Estimasi</td>
                           <td colspan="2"><input type="text" readonly name="totalestimasi" class="form-control" value="0" >&nbsp;<small><span id="testimasi"></span></small></td>
                       </tr>
                       <tr>
...
function updateppnbaris(){
    ...
    if($("select[name='biaya["+i+"][jenisbiaya_id]']").val() != undefined){
      ...
      total=$("input[name='biaya["+i+"][total]']").val();
	  ppnperbaris=$("input[name='biaya["+i+"][ppn]']").val();
    //$('#ppnbaris'+i).html(numberWithCommas(ppnperbaris));
	  //alert(ppnperbaris);
      error=false;
  ...
  $("input[name='ppn']").val(totalppnbaris);
...
function addBiaya(){ 
  ...
  html += '<td class="left"><input class="form-control" onblur="updateppnbaris()"  type="text" name="biaya[' + biaya_row + '][ppn]" value="0" />&nbsp;<small id=ppnbaris'+biaya_row+'></small></td>'
  html += '    <td class="right"><input class="form-control" onblur="updatetotal()"  type="text" name="biaya[' + biaya_row + '][totalreal]" value="0" /><input class="form-control"  type="hidden"  name="biaya[' + biaya_row +'][total]" value="0" /><input class="form-control"  type="hidden" name="biaya[' + biaya_row + '][id]" value="0" />&nbsp;<small id=realbaris'+biaya_row+'></small></td>';
	 ...
	 //alert(id);
      ...
      success: function(json) {
        ...
        $(".loader").fadeOut(2000);
          ...
          tr.append("<td>" + numberWithCommas(v.totalreal) + "</td>");
          $("#listbiaya").append(tr);
        });
      },
