      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Barang Datang Pembelian Bahan Baku</h3>
...
$(function(){
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/pembeliankreditbahanbaku/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/barangdatangbahanbaku&token=<?php echo $token; ?>';
