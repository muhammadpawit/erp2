                      ...
                      <tr>
                        ...
                        <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['text']=='Lihat Jurnal'?'target="_blank"':''; ?> class="badge bg-blue"><?php echo $action['text']; ?></a><br>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/invoicepembelianimport&token=<?php echo $token; ?>';
