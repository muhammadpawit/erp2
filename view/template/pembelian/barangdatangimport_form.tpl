              ...
              <div class="col-md-12">
                ...
                <table class="table">
                  <tr>
                      ...
                      <td><?php echo $permintaan['no_faktur'] ?>
                        <input class="form-control" type="hidden" name="pembelian_import_id" value="<?php echo $permintaan['id'] ?>">
                      </td>
                  </tr>
                  <tr>
                      <td>Gudang:</td>
                      <td><?php echo $gudang['nama'] ?>
                        ...
                        <input class="form-control" type="hidden" name="kursbank" value="<?php echo $permintaan['kursdatang'] ?>">
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <td><input class="date form-control" type="text" required name="tgl_surat" readonly value="<?php echo date('Y-m-d'); ?>"></td>
                  </tr>
                  <tr>
                     <td>Jenis Persediaan</td>
                     <td >
                       <select name="jenispersediaan" class="form-control">
                          <option value="1202">Persediaan barang jadi</option>
                       </select>
                     </td>
                   </tr>
                   <tr>
                  ...
                  <tr>
                     <td>Penerima:</td>
                     <td><select name="penerima_id" class="penerima form-control">
                 ...
                 <tr>
                    <td>Pengangkut:</td>
                    <td><select name="pengangkut_id" class="penerima form-control">

                      </select>
                    <input class="form-control" type="hidden" name="pengangkut" value=""></td>
                </tr>
                <?php
                if($permintaan['jenisproduk'] == 1){
                ?>
                <tr>
               ...
               <tr>
                ...
                <tr style="display:none">
                   <td>Kurs KMK:</td>
                   <td><input class="form-control" type="text" name="kurskmk" value=""></td>
               </tr>
               <tr style="display:none">
                  <td>Kurs Tengah BI:</td>
                  <td><input class="form-control" type="text" name="kursbi" value=""></td>
              </tr>
                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        if($permintaan['jenisproduk'] == 1){
                        ?>
                        <td><input class="form-control" type="text" name="products[<?php echo $i; ?>][levelawal]" value="<?php echo empty($p['detail']['level'])?0:$p['detail']['level'];?>" readonly></td>
