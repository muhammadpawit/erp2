                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php
                          ...
                          ?></td>
                          <td><?php echo $product['jumlah']; ?>
                          </td>
                          <td><?php echo $product['biaya']; ?>
                          </td>
                          <td><?php echo $product['pendapatan']; ?>
                          </td>
                      ...
                      <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>" <?php echo $action['text'] == 'Lihat Jurnal'?'target="_blank"':''; ?>  <?php echo $action['text']=='Cetak PO'?'target="_blank"':''; ?> class="badge bg-yellow"><?php echo $action['text']; ?></a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/pembayarandepositkredit&token=<?php echo $token; ?>';
