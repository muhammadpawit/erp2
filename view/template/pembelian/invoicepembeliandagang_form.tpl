      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Buat Invoice Pembelian Produk Dagang</h3>
                ...
                <div class="col-sm-6 col-xs-12">
                  <table class="table table-responsive" >
                    ...
                    <tr>
                      <td>Pajak</td>
                      <td>
                        <input type="text" class="form-control" name="pajak" id="pajak" value="" onblur="updatepajak()">
                    ...
                    <!--
                    <tr>
                      <td>Contoh Pembulatan</td>
                      <td>
                      <input type="text" class="form-control" name="hasilbulatan" id="hasilbulatan" value="">
                      </td>
                    </tr>
                    -->
                  </table>
...
$(document).ready(function() {
  ...
  theme:"bootstrap"
    ...
    $.ajax({
      url: 'index.php?route=pembelian/pembeliankreditdagang/detail&token=<?php echo $this->request->get['token']; ?>&vendor_id=' + id+'&gudang_id='+gudang_id,
      dataType: 'json',
      success: function(json) {
        if(json){
          ...
          //console.log(json.products.sort(sortByProperty("quantity")));
          html='';
          net_cost=0;

          for(i in json.products.sort(sortByProperty("quantity"))){
            if(json.products[i].quantity>0){
...
dp=Number($("#dp").val());
  ...
  if(!error){
    ...
    $("#sub_totalpo").val(sub_totalpo.toFixed(2));
    //$("#hasilbulatan").val(sub_total.toFixed(2));
    $("#pajak").val(pajak.toFixed(2));
    $("#pajakpo").val(pajakpo.toFixed(2));

  $("#diskon").val(diskon.toFixed(2));
    $("#total").val(t.toFixed(2));
    $("#totalpo").val(totalpo.toFixed(2));
