      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Pembayaran Pembelian Import

            </h3>
            <div class="button pull-right">
                  <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Tambah</button></a>
                  <a href="<?php echo $penyesuaian; ?>"><button type="button" class="btn btn-primary">Penyesuaian Kurs</button></a>
								</div>
          </div>
          <div class="box-body">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tbody>
                    <tr>
                    <td><select name="filter_no_po" class="form-control nosurat">
            ...
            <div class="row">
              <div class="col-md-12">
                <h4>Rincian Pembayaran Pembelian Import</h4>
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $totalbayar; ?><br>
                      <smal>Total Pembayaran (Kurs Bank): <?php echo $totalrp; ?></small>
                    </td>
                  </tr>
                </table>
              </div>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['nama']; ?></td>
                          <td><?php echo $product['jumlah']; ?><br>
                            <small>Total (Rp):  <?php echo $product['kurs']; ?></small>
                          </td>
                        <td><?php echo $product['biaya_bank']; ?></td>
...
$('.sidebar-menu').find('#menu-pembayaran-dp').addClass('active');
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/pembayarandpimport&token=<?php echo $token; ?>';
