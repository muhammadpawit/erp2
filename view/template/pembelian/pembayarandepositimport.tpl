              ...
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td>
                        <select style="width:200px;" name="filter_vendor_id" class="form-control lokasi-pameran">

                        </select>
                      </td>
                      <td>
                        <textarea name="filter_keterangan" class="form-control"><?php echo $filter_keterangan?></textarea>
                      </td>
                ...
                <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>Kurs</th>
                        <th>Total Telah Dialokasikan</th>
                        <th>Status</th>
                        <th></th>
                    ...
                    <tbody id="hilitor">
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['no_giro']."".$product['no_cheque']; ?></td>
                        <td><?php echo $product['no_kontrak']; ?></td>
                        ...
                        <td><?php
                          ...
                          ?></td>
                          <td><?php echo $product['jumlah']; ?><br>
                            (<?php echo $product['totalrupiah']; ?>)
                          </td>
                          <td><?php echo $product['kurs']; ?></td>
                          <td><?php echo $product['totalalokasi']; ?></td>
                          <td>
                            <?php
                              if($product['status'] == 1){
                                echo 'Disimpan';
                      ...
                      <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['text']=='Lihat Jurnal'?'target="_blank"':''; ?> class="badge bg-yellow"><?php echo $action['text']; ?></a>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/pembayarandepositimport&token=<?php echo $token; ?>';
  ...
  var filter_keterangan = $('textarea[name=\'filter_keterangan\']').val();
