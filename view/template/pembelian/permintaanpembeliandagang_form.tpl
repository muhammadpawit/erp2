                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>Kebutuhan Tanggal</td>
                        <td><input type="text" name="kebutuhan_tanggal" class="form-control date" autocomplete="off"></td>
                     </tr>
                  </table>
...
function simpan(){
  ...
  tanggal=$("input[name='kebutuhan_tanggal']").val();
