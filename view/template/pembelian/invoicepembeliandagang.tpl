      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Invoice Pembelian Produk Dagang</h3>
            <div class="button pull-right">
                  <a href="<?php echo $exporttoexcel; ?>" target="_blank"><button type="button" class="btn btn-success">Export to Excel</button></a>
                  <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Buat Invoice</button></a>
								</div>
          </div>
          <div class="box-body">
            <div class="row">
                    ...
                    <td>
                      ...
                      <td>
                          <select class="form-control" name="filter_status">
                            ...
                            <option value="5" <?php echo $filter_jenis_barang == 5?'selected':''; ?>>Permintaan Perubahan Harga</option>
                      ...
                      <tr>
                        ...
                        <td class="right"><?php foreach ($product['actions'] as $action) {
                          ...
                          ?>
                           ...
                           <a href="<?php echo $action['href']; ?>"  <?php echo $action['text']=='Lihat Jurnal'?'target="_blank"':''; ?> class="badge <?php echo $action['text']=='Setujui Perubahan Harga'?'bg-yellow':($action['text']=='Tolak Perubahan Harga'?'bg-red':'bg-blue'); ?>"><?php echo $action['text']; ?></a><br>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/invoicepembeliandagang&token=<?php echo $token; ?>';
