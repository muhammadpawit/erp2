                  ...
                  <table class="table">
                    ...
                    <tr>
                     ...
                     <tr>
                         ...
                         <td><input type="text" name="nominal" onchange="updatetotal()" value="<?php echo $nominal; ?>" >&nbsp;<i><span id="total"></span></i></td>
                     </tr>
                     <tr>
                         <td>Kurs</td>
                         <td><input type="text" name="kurs" onchange="updatetotal()" value="<?php echo $kurs; ?>" >&nbsp;<i><span id="kurs"></span></i></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         ...
                         <td><input type="text" name="biaya_bank" value="<?php echo $biaya_bank; ?>" onblur="biayabank()">&nbsp;<i><span id="biaya_bank"></span></i></td>
                     </tr>
                    </table>
