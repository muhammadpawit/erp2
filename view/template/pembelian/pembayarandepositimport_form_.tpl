                  ...
                  <table class="table">
                    ...
                    <tr>
                     ...
                     <tr>
                         ...
                         <td><input type="text" name="nominal" class="form-control" onchange="updatetotal()" value="<?php echo $nominal; ?>" ></td>
                     </tr>
                     <tr>
                         <td>Kurs</td>
                         <td><input type="text" name="kurs" class="form-control" onchange="updatetotal()" value="<?php echo $kurs; ?>" ></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         ...
                         <td><input type="text" name="biaya_bank" class="form-control" value="<?php echo $biaya_bank; ?>" onblur="biayabank()"></td>
                     </tr>
                    </table>
...
function biayabank(){
  ...
  //$("input[name='biaya_bank']").val(addCommas(b))
}
...
function updatetotal(){
  ...
  //$("input[name='nominal']").val(addCommas(nominal));
  //$("input[name='kurs']").val(addCommas(kurs));
}
function simpan(){
  $(".error").remove();
  error=false;
  ...
  if(!$.isNumeric( Number($("input[name='kurs']").val())) ) {
    error=true;
