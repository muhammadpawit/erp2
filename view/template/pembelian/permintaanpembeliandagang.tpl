      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Permintaan Pembelian Produk Dagang</h3>
                ...
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td><input type="text" class="form-control" name="filter_no_surat" value="<?php echo $filter_no_surat; ?>"></td>
                       <td><input type="text" class="form-control" name="filter_keterangan" value="<?php echo $filter_keterangan; ?>"></td>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['nmvendor']; ?></td>
                        ...
                        <td>
                          <?php 
                            $tgl=date('d F Y',strtotime($product['tgl_kebutuhan'])) ; 
                              if($tgl!="01 January 1970")
                              {
                                $tgl = date('d F Y',strtotime($product['tgl_kebutuhan']));
                              } 
                              else
...
<script type="text/javascript"><!--
function filter() {
  url = 'index.php?route=pembelian/permintaanpembeliandagang&token=<?php echo $token; ?>';
