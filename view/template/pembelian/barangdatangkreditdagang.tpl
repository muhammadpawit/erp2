        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <div class="button pull-right">
              <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Input Surat Jalan</button></a>
            </div>
          </div>
          <div class="box-body">
            <div class="row">
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/barangdatangdagang&token=<?php echo $token; ?>';
