    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
           ...
           <small>Tanggal: <?php echo date('d/m/y',strtotime($permintaan['date_added'])); ?></small>
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              ...
              <th>
                <?php
                echo $permintaan['jumlah'] < 100000?'Bagian Keuangan':'Direktur Keuangan'; 
                ?>
              </th>
            </tr>
