      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Pembayaran Tagihan Biaya Pembelian Lokal</h3>
...
$(document).ready(function() {
  ...
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/tagihanbiayalokal/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
  ...
  theme:"bootstrap"
    ...
    if(id != undefined & id != null){
      ...
      invoice=$(".invoice").val();
    $.ajax({
      url: 'index.php?route=pembelian/tagihanbiayalokal/detailbiaya&token=<?php echo $this->request->get['token']; ?>&id='+id,
      dataType: 'json',
      success: function(json) {
        if(json){

          console.log(JSON.stringify(json));
          sisatagihan=Number(json.total)-Number(json.totalbayar);
