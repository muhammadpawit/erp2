      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Kasbon Pembelian</h3>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo $this->url->link('pembelian/permintaanpembelian/tampil', 'token=' . $this->session->data['token'] . '&id=' . $product['surat_id'], 'SSL'); ?>" target="_blank"><?php echo $product['pno_surat']; ?></a></td>

                        <td><?php echo $product['tujuan']; ?></td>
