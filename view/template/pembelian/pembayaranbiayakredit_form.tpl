...
$(document).ready(function() {
  ...
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/biayapembeliankredit/autocompletepembayaran&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
  ...
  theme:"bootstrap"
    ...
    if(id != undefined & id != null){
      ...
      invoice=$(".invoice").val();
    $.ajax({
      url: 'index.php?route=pembelian/biayapembeliankredit/detailbiaya&token=<?php echo $this->request->get['token']; ?>&id='+id,
      dataType: 'json',
