            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                      if($permintaan['statuspenerimaan'] == 0){
                        if($p['status'] == 1){
                      ?>
                      <a href="<?php echo $this->url->link('pembelian/pembayaranpembelianimport/batalkan', 'token=' . $this->session->data['token'] . $url.'&id='.$p['id'], 'SSL'); ?>"  class="badge bg-red">Batalkan</a>
                      <?php
                        }else{
