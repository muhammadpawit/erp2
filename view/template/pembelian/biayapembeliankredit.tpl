      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Biaya Pembelian Produk Dagang</h3>
            <div class="button pull-right">
                  <!--a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Input Tagihan Biaya</button></a>
...
$(".nofaktur").select2({
  ajax: {
  url:"index.php?route=pembelian/biayapembeliankredit/autocomplete&token=<?php echo $this->request->get['token']; ?>",
  dataType: 'json',
  data: function (params) {
    return {
      q: params.term,
...
function filter() {
	url = 'index.php?route=pembelian/biayapembeliankredit&token=<?php echo $token; ?>';
