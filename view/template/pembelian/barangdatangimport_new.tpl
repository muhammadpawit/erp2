            ...
            <div class="row">
              <div class="col-md-12">
                <table class="table table-stripped">
                    <thead>
                      <tr>
                        <th colspan="2">Filter Tanggal Faktur</th>
                        <th>Nomor Faktur</th>
                    ...
                    <tr>
                      <td colspan="2"><b>Tanggal Terima</b></td>
                    ...
                    <tr>
                      <td>
                        <input type="text" class="form-control" placeholder="Tanggal terima" name="date_terima_start" value="<?php echo $date_terima_start; ?>" id="date-terima-start" size="12"  />
                      </td>
                      <td>
                        <input type="text" class="form-control" placeholder="Tanggal terima" name="date_terima_end" value="<?php echo $date_terima_end; ?>" id="date-terima-end" size="12"  />
                      </td>
                      <td>
...
$(document).ready(function() {
  ...
  $('#date-terima-start').datepicker({dateFormat: 'yy-mm-dd'});
	$('#date-terima-end').datepicker({dateFormat: 'yy-mm-dd'});
});
//--></script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/barangdatangimport&token=<?php echo $token; ?>';
  ...
  var date_terima_start = $('input[name=\'date_terima_start\']').val();
	if (date_terima_start) {
		url += '&date_terima_start=' + encodeURIComponent(date_terima_start);
	}

  var date_terima_end = $('input[name=\'date_terima_end\']').val();
	if (date_terima_end) {
		url += '&date_terima_end=' + encodeURIComponent(date_terima_end);
	}
