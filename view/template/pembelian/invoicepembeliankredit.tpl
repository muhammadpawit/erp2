...
$(function(){
  $(".nosurat").select2({
    ajax: {
    url:"index.php?route=pembelian/invoicepembeliankredit/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=pembelian/invoicepembeliankredit&token=<?php echo $token; ?>';
