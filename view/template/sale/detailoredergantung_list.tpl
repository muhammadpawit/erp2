          ...
          <div class="box-header with-border">
            ...
            <div class="button pull-right">
              <?php // if($this->user->getUsername()=="pawit") { ?>
                <a href="<?php echo $cetakexcel; ?>" target="_blank"><button class="btn btn-primary">export to excel</button></a>
                <a href="<?php echo $cetakbiasa; ?>" target="_blank"><button class="btn btn-primary">cetak</button></a>
              <?php // } ?>
            </div>
          </div>
          <div class="box-body">
                      ...
                      <tr>
                        ...
                        ?></td>
                         ...
                         <td <?php echo $product['status'] == 4?'style="background:#f3bfbf;"':'';?> class="right"><?php foreach ($product['action'] as $action) { ?>
                          <a class="badge bg-green" target="_blank" href="<?php echo $action['href']; ?>"><?php echo $action['text']; ?></a>
                          <?php } ?>
                          <?php
                          if($product['status'] == 4){
...
function filter() {
	url = "index.php?route=sale/sogantung/sogantung&token=<?php echo $token; ?>";
