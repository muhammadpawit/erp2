      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Penjualan Bahan Baku</h3>
...
theme:"bootstrap"
  ...
  $(".no_so").select2({
    ajax: {
    url:"index.php?route=sale/salesorderbahanbaku/autocomplete&token=<?php echo $token; ?>",
    //url: "index.php?route=pamerantoko/toko/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
    data: function (params) {
      return {
  ...
  theme:"bootstrap"
    ...
    $.ajax({
      url: 'index.php?route=sale/salesorderbahanbaku/detail&token=<?php echo $token; ?>&id=' + id,
      dataType: 'json',
