      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Surat Jalan Penjualan Bahan Baku</h3>
...
function filter() {
	url = "index.php?route=sale/penjualanbahanbaku&token=<?php echo $token; ?>";
...
$(function(){
  ...
  $(".salesorder").select2({
    ajax: {
    url:"index.php?route=sale/penjualanbahanbaku/autocomplete&token=<?php echo $token; ?>",
    //url: "index.php?route=pamerantoko/toko/autocomplete&token=<?php echo $this->request->get['token']; ?>",
    dataType: 'json',
    data: function (params) {
      return {
