      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Surat Jalan Penjualan</h3>
            <div class="button pull-right">
              <a href="<?php echo $downloadexcel; ?>" target="_blank"><button type="button" class="btn btn-warning">Export to Excel</button></a>
              ...
              <div class="col-md-12">
                <table class="table table-condensed">
                    ...
                    <tr>
                      ...
                      <td>
                          <select class="form-control" name="filter_gudang_id" style="width:300px">
                        ...
                        <td>
                          <select name="filter_order_id" class="salesorder form-control" style="width:350px">
                    ...
                    <tr>
                      ...
                      <td>
                            <select name="filter_invoice" class="invoice form-control">
                    ...
                    <tbody>
                      ...
                      <tr class="filter">
                        <td> <input type="text" class="date" name="filter_tanggal_awal" value="<?php echo $filter_tanggal_awal; ?>" /><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Tanggal Akhir</b><br>
						              <input type="text" class="date" name="filter_tanggal_akhir" value="<?php echo $filter_tanggal_akhir; ?>" />
                        </td>
                        <td>
                        ...
                        <td>
                          <select name="filter_status" class="form-control">
          		          ...
          		          <td align="right"><a onclick="filter();" class="btn btn-info"><i class="fa fa-search"></i></a></td>
                      </tr>-->
                      ...
                      <tr>
                        ...
                        <td><?php
                                if($product['status'] == 1 && $product['qtyreturn']==0){
                                  echo 'Proses Kirim';
                                }
                                if($product['status'] == 2){
                                  echo 'Diterima';
                                ...
                                if($product['qtyreturn']>0){
                                  echo 'Diretur '.$product['qtyreturn'];
                                }

                        ?></td>

                         <td class="right"><?php foreach ($product['action'] as $action) { ?>
                          <a class="badge bg-green" style="margin-bottom:8px;" href="<?php echo $action['href']; ?>" <?php echo $action['text']=='Lihat Jurnal'?'target="_blank"':''; ?>><?php echo $action['text']; ?></a><br>
                          <?php } ?></td>
                      </tr>
                      <?php } ?>
                      <?php } else { ?>
...
function filter() {
	url = "index.php?route=sale/penjualan&token=<?php echo $token; ?>";
