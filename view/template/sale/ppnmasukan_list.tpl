      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Daftar PPn Keluaran</h3>
            <div class="button pull-right">
              <?php if($this->user->getUsername()=="pawit"){ ?>
                <a href="<?php echo $export ?>" target="_blank"><button class="btn btn-default"><i class="fa fa-file-excel-o"></i> Export</button></a>
              <?php } ?>
              <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Input No. Faktur Pajak</button></a>
            </div>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-bordered">
                    <tr>
                      <td width="300"><b>Tanggal Awal</b></td>
                      <td><b>Gudang</b></td>
                    ...
                    <tr>
                      <td width="300">
                        <input type="text" class="form-control date" name="filter_tanggal" value="<?php echo $filter_tanggal; ?>" /><b>Tanggal Akhir</b>
                        <input type="text" class="form-control date" name="filter_tanggal2" value="<?php echo $filter_tanggal2; ?>" />
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <b><?php echo $totaldpp?></b>
                      </td>
                      <td>
                        <b><?php echo $totalppn?></b>
                      </td>
                      <td></td>
                      <td></td>
                    </tr>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['dpp']; ?></td>
                        <td><?php echo $product['ppn']; ?></td>
                        <td><?php echo $product['no_fakturpajak']; ?></td>
...
$('.sidebar-menu').find('#menu-faktur-pajak').addClass('active');</script>
<script>
$(function(){
...
function filter() {
	url = "index.php?route=sale/ppnmasukan&token=<?php echo $token; ?>";
  ...
  var filter_tanggal2 = $('input[name=\'filter_tanggal2\']').val();

  if (filter_tanggal2) {
    url += '&filter_tanggal2=' + encodeURIComponent(filter_tanggal2);
  }
