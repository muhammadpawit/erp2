        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <div class="button pull-right">
              <a href="<?php echo $insert; ?>"><button type="button" class="btn btn-primary">Tambah Proforma Invoice</button></a>
            </div>
          </div>
          <div class="box-body">
            <div class="row">
...
function filter() {
	url = "index.php?route=sale/proforma&token=<?php echo $token; ?>";
