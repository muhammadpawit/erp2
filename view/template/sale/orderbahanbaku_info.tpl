      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Sales Order Penjualan Bahan Baku <?php echo $order['no_so']; ?></h3>
            <div class="button pull-right">
                  <?php if($this->user->getUsername()=="pawit"){?>
                    ...
                    <?php } ?>
                  <a href="index.php?route=sale/salesorderbahanbaku/tampilcetak&token=<?php echo $this->session->data['token'];?>&order_id=<?php echo $_REQUEST['order_id']?>" target="_blank"><button class="btn btn-default"><i class="fa fa-print"></i> Print</button></a>
              ...
              <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $p['statuspajak'] == 1?'Dikenai PPn':'Tidak Dikenai PPn'; ?></td>
