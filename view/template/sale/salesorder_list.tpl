                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td <?php echo $product['status'] == 4?'style="background:#f3bfbf;"':'';?>><?php echo $product['nama']; ?></td>
                        <td <?php echo $product['status'] == 4?'style="background:#f3bfbf;"':'';?> class="left"><?php echo $product['no_so']; ?><br>
                        ...
                        <td <?php echo $product['status'] == 4?'style="background:#f3bfbf;"':'';?>><?php echo $product['total']; ?></td>
                        ...
                        ?></td>
                         ...
                         <td <?php echo $product['status'] == 4?'style="background:#f3bfbf;"':'';?> class="right"><?php foreach ($product['action'] as $action) { ?>
                          <a class="badge bg-green" href="<?php echo $action['href']; ?>"><?php echo $action['text']; ?></a><br>
                          <?php } ?>
                          <?php
                          if($product['status'] == 4){
...
function filter() {
	url = "index.php?route=sale/salesordermr&token=<?php echo $token; ?>";
