      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Sales Order Penjualan MR</h3>
                    ...
                    <?php
                     ...
                     <tr>
                      ...
                      <tr>
                           <td>Nomor TTTK</td>
                           <td>
                             <select name="tttk" class="no_so form-control">
  ...
  // alert($("input[name='product["+i+"][quantity]']").val());
    ...
    //  diskonproduk=$("input[name='product["+i+"][diskon]']").val();
      ...
      if($.isNumeric( Number(quantity) ) & $.isNumeric( Number(harga) )){
          ...
          if(nilaipajak == 2){
            hargasatuan=(Math.round((100/110)*(harga*quantity)))/quantity;
            //  pajak=Math.round((10/110)*harga);
            pajak=Math.round((10/110)*(harga*Number(quantity)));
...
function addModule() {
  ...
  html +='<td class="center" style="width: 3px;"><img src="view/image/delete.png" onclick="hapus('+product_row+')" style="cursor: pointer;" /></td>';
	...
	html += '    <td class="left"><select style="width:300px" data-id="'+product_row+'" name="product[' + product_row + '][product_id]" class="product form-control"></select></td>';
    ...
    $.ajax({
      ...
      //  $("#total").val(json.order.total);
        ...
        for(i in json.products){
          ...
          html += '    <td class="left"><input type="text" class="form-control" class="product-name" onblur="hitungtotal()"  name="product[' + product_row + '][no_tabung]" value="'+json.products[i].no_tabung+'" readonly/><input type="hidden" name="product[' + product_row + '][tabung_id]" value="'+json.products[i].tabung_id+'" /><input type="hidden" name="product[' + product_row + '][quantityterima]" value="'+json.products[i].quantityterima+'" /></td>';
