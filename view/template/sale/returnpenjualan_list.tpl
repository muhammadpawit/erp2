      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Return Penjualan</h3>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        foreach($product['product'] as $p){
                          echo $p['quantity'].' x '.$p['name'].'<br>';
                        }
                         ?></td>
                        <td><?php echo $product['totalrefund']; ?> </td>
...
function filter() {
	url = "index.php?route=sale/returnpenjualan&token=<?php echo $token; ?>";
