      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Kode Premi</h3>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $category['kelompok']; ?></td>
                        <td><?php echo $category['kelompok2']; ?></td>
                        <td><?php echo $category['kelompok3']; ?></td>
                        <td><?php echo $category['kelompok4']; ?></td>

                      </tr>
                      <?php } ?>
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="8">Data sapaan tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
$('.sidebar-menu').find('#menu-kodepremi').addClass('active');
</script>
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=kepegawaian/kodepremi&token=<?php echo $token; ?>';
