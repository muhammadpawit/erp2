                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="left">Nama Tunjangan</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="left"><?php echo $category['satuan'] == 1?'Harian':'Bulanan'; ?></td>
                        <td class="left"><?php echo $category['status'] == 1?'Aktif':'Tidak Aktif'; ?></td>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="4">Data tunjangan tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
function filter() {
	url = 'index.php?route=kepegawaian/mtunjangan&token=<?php echo $token; ?>';
