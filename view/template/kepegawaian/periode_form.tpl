                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-stripped">
                    <tr>
                      ...
                      <td><input type="text" name="nama" size="100" value="<?php echo isset($periode['nama']) ? $periode['nama'] : ''; ?>" required />
                      </td>
                    </tr>
                    <tr>
                      <td>Tanggal Awal Periode</td>
                      <td><input type="text" name="tgl_awal" size="100" class="date" value="<?php echo isset($periode['tgl_awal']) ? $periode['tgl_awal'] : ''; ?>"  />
                      </td>
                    </tr>
                    <tr>
                      <td>Tanggal Akhir Periode</td>
                      <td><input type="text" name="tgl_selesai" size="100" class="date" value="<?php echo isset($periode['tgl_selesai']) ? $periode['tgl_selesai'] : ''; ?>"  />
                      </td>
                    </tr>
                  </table>
                </form>
