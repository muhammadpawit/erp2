                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="left">Nama Pegawai</th>
                        <th class="left">Jam Datang</th>
                        <th class="left">Jam Pulang</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="left"><?php echo $category['tanggal']; ?></td>
                        <td class="left"><?php echo $category['name']; ?></td>
                        <td class="left"><?php echo $category['jam_datang']; ?></td>
                        <td class="left"><?php echo $category['jam_pulang']; ?></td>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="center" colspan="8">Data absensi tidak ditemukan</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
function filter() {
		url = 'index.php?route=kepegawaian/absensi&token=<?php echo $token; ?>';
