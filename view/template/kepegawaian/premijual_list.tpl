      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Akumulasi Premi Jual <?php echo isset($periode)?'Periode '.$periode['nama']:'';?>
...
<script type="text/javascript"><!--
function filter() {
		url = 'index.php?route=kepegawaian/premijual&token=<?php echo $this->request->get['token']; ?>';
