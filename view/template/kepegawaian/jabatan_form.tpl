              ...
              <div class="col-md-12">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <table class="table table-stripped">
                    <tr>
                      <td><span class="required">*</span>  Nama Jabatan</td>
                      <td><input type="text" name="nama" size="100" value="<?php echo isset($jabatan['nama']) ? $jabatan['nama'] : ''; ?>" required />
                      </td>
                    </tr>
                    <tr>
                      <td>Tunjangan</td>
                      <td><input type="text" name="tunjangan" size="100" value="<?php echo isset($jabatan['tunjangan']) ? $jabatan['tunjangan'] : ''; ?>"  />
                      </td>
                    </tr>
                  </table>
                </form>
...
$('.sidebar-menu').find('#menu-jabatan').addClass('active');
</script>
<?php echo $footer; ?>
