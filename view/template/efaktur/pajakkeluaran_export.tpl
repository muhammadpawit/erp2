...
header("Content-Disposition: attachment; filename=FileImport".date('d-m-Y').".xls");
?>
<?php //echo $header; ?>
                    ...
                    <tbody>
                      ...
                      <?php foreach($product['products'] as $p ){?>
                        <tr>
                          ...
                          <td><?php echo $p['pajak'] //$ppn=0; $ppn=($p['price']*$p['quantity'])/10; echo round($ppn,0,PHP_ROUND_HALF_DOWN); ?></td>
                          <td class="str">0</td>
                          <td class="str">0</td>
                          <td></td>
                          <td class="str"></td>
