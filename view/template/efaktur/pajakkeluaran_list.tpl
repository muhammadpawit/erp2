      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">E-Faktur Pajak Keluaran</h3>
            ...
            <div class="row">
              <div class="col-xs-12">
                <table class="table table-stripped">
                  ...
                  <tr>
                    <td>Nomor Faktur</td>
                    <td><input type="text" name="nomorfaktur" class="form-control" value="<?php echo $nomorfaktur ?>" placeholder="dimulai dari nomor faktur" required="required"></td>
                  </tr>
                  <tr>
                    <td><a onclick="filter();" class="btn btn-info">Filter</a></td>
                    <td><a href="<?php echo $export ?>" target="_blank"><button class="btn btn-default"><i class="fa fa-file-excel-o"></i> Exports</button></a></td>
                  </tr>
                  <!-- <tr>
                    ...
                    <tbody>
                      ...
                      <?php foreach($product['products'] as $p ){?>
                        <tr>
                          ...
                          <td><?php echo $p['pajak'] //$ppn=0; $ppn=($p['price']*$p['quantity'])/10; echo $ppn; //echo round($ppn,0,PHP_ROUND_HALF_DOWN); ?></td>
                          <td class="str">0</td>
                          <td class="str">0</td>
                          <td></td>
                          <td class="str"></td>
...
function filter() {
	url = "index.php?route=efaktur/pajakkeluaran&token=<?php echo $token; ?>";
  ...
  var filter_date_start = $('input[name=\'filter_date_start\']').val();
   ...
   var nomorfaktur = $('input[name=\'nomorfaktur\']').val();
   if(nomorfaktur==""){
      swal("Nomor faktur harap disisi!");
      return false;
   }
  if (nomorfaktur) {
    url += '&nomorfaktur=' + encodeURIComponent(nomorfaktur);
  }
