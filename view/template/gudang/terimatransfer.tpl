      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Terima Transfer Item</h3>
              ...
              <div class="col-md-12">
                <table class="table table-stripped">
                    ...
                    <tr>
                      ...
                      <td>
                        <select style="width:200px" name="filter_tujuan" class="select-ads">
                          <option value="*">Semua Gudang</option>
                          <?php
                          foreach($tujuans as $g){
                          ?>
                            <option value="<?php echo $g['gudang_id'] ?>" <?php echo $filter_tujuan == $g['gudang_id']?'selected':'';?>><?php echo $g['nama'] ?></option>
                          <?php
                          }
                          ?>
                        </select>
                ...
                <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="left">No.Terima Dokumen</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $product['no_terimadokumen']; ?></td>
                       <td><?php echo $product['invoice_no']; ?></td>
                        ...
                        <td class="right"><?php foreach ($product['actions'] as $action) {
                          if($action['text'] == 'x'){
                          ?>
                          <a href="<?php echo $action['href']; ?>" class="badge bg-red">Proses Selisih</a>
                          <?php
                          }else{
                          ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=gudang/terimatransfer&token=<?php echo $token; ?>';
