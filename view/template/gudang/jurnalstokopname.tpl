      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Pengaturan Jurnal Pemrosesan Stok Opname</h3>
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  <div id="tab-general">
                    <table class="table table-bordered">
                      <tr>
                        <td>Barang Hilang</td>
                        <td><select class="form-control" name="config_qtyhilang">
                          <option value="0">Belum Diatur</option>
                            <?php foreach ($categories as $category) { ?>
                            <?php if ($category['category_id'] == $config_qtyhilang) { ?>
                      ...
                      <tr>
                        <td>Barang Rusak</td>
                        <td><select class="form-control" name="config_qtyrusak">
                          <option value="0">Belum Diatur</option>
                            <?php foreach ($categories as $category) { ?>
                            <?php if ($category['category_id'] == $config_qtyrusak) { ?>
                            <option value="<?php echo $category['category_id']; ?>" selected="selected"><?php echo  $category['kode_rek'].' '.$category['name']; ?></option>
                            <?php } else { ?>
                            <option value="<?php echo $category['category_id']; ?>"><?php echo  $category['kode_rek'].' '.$category['name']; ?></option>
                            <?php } ?>
                      ...
                      <tr>
                        <td>Kelebihan Stok</td>
                        <td><select class="form-control" name="config_kelebihanstok">
                          <option value="0">Belum Diatur</option>
                            <?php foreach ($categories as $category) { ?>
                            <?php if ($category['category_id'] == $config_kelebihanstok) { ?>
                            <option value="<?php echo $category['category_id']; ?>" selected="selected"><?php echo  $category['kode_rek'].' '.$category['name']; ?></option>
                            <?php } else { ?>
                            <option value="<?php echo $category['category_id']; ?>"><?php echo  $category['kode_rek'].' '.$category['name']; ?></option>
                            <?php } ?>
