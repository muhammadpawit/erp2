...
<head>
  ...
  <title>PT.Nisson Indonesia | Surat Jalan Transfer <?php echo $transfer['detail']['invoice_no']; ?></title>
      ...
      <div class="col-xs-12">
        <h2 class="page-header">
          ...
          <small class="pull-right"><?php echo $transfer['detail']['asal']; ?> >> <?php echo $transfer['detail']['gudang_tujuan']; ?></small>
					<br>
					Surat Jalan Transfer Antar Gudang <?php echo $transfer['detail']['invoice_no']; ?>
        </h2>
      </div>
      <!-- /.col -->
    </div>
        ...
        <table class="table">
          ...
          <tbody>
                ...
                foreach($p['options'] as $o){
                  echo $o['name']."(".$o['quantity']."), ";
                }
                ?>

              </td>
              <td><?php echo $p['quantity']; ?></td>
							<td><?php echo $transfer['detail']['jenis'] == 2?$p['harga_jual'].' Poin':$this->currency->format($p['harga_jual']); ?></td>
						</tr>
						<?php
						}
						?>
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              ...
              <td>:&nbsp;<?php echo ($transfer['detail']['tglterima']==null)?'':date('d F Y', strtotime( $transfer['detail']['tglterima'])); ?></td>
            </tr>
            <tr>
              <th style="width:50%">Penerima</th>
              <td>:&nbsp;</td>
            </tr>
