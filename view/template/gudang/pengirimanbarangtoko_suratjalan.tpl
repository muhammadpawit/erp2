...
<head>
  ...
  <title>Mom & Bab | Surat Jalan Pengiriman Barang Toko <?php echo $transfer['detail']['invoice_no']; ?></title>
      ...
      <div class="col-xs-12">
        <h2 class="page-header">
          ...
          <small class="pull-right"><?php echo $transfer['detail']['asal']; ?> >> <?php echo $transfer['detail']['gudang_tujuan']; ?></small>
					<br>
					Surat Jalan Pengiriman Barang Toko <?php echo $transfer['detail']['invoice_no']; ?>
        </h2>
      </div>
      <!-- /.col -->
    </div>
