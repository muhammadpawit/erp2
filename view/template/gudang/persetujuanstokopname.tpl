      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Persetujuan Stok Opname</h3>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                ...
                ?>
                <?php if ($config_qtyrusak < 1 | $config_qtyhilang < 1 | $config_kelebihanstok < 1) { ?>
                <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h4><i class="icon fa fa-check"></i> Perhatian!</h4>
                  Jurnal Pencatatan untuk Stok Opname belum diatur. Mohon diatur terlebih dahulu.
                </div>
                <?php
                }
                ?>
...
<script type="text/javascript"><!--
function filter() {
	url = 'index.php?route=gudang/persetujuanstokopname&token=<?php echo $token; ?>';
