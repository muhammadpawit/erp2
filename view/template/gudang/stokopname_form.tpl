                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                  ...
                  <tbody id="product-row<?php echo $product_row; ?>">
                    <tr>
                        ...
                        <td class="left"><input class="form-control" type="text" data-id="<?php echo $product_row; ?>" class="product-name" name="product[<?php echo $product_row ?>][name]" value="<?php echo $product['name'] ?>" />
                      ...
                      <td class="left"><input class="form-control" type="text" name="product[<?php echo $product_row ?>][qtytercatat]" /></td>
                      <td class="left"><input class="form-control" type="text" name="product[<?php echo $product_row ?>][qtyrusak]" /></td>
                      <td class="left"><input class="form-control" type="text" name="product[<?php echo $product_row ?>][qtyhilang]" /></td>
                      <td class="left"><input class="form-control" type="text" name="product[<?php echo $product_row ?>][qtytersedia]" /></td>
                      <td class="left"><input class="form-control" type="text" name="product[<?php echo $product_row ?>][keterangan]" /></td>
