                    ...
                    <thead>
                      <tr>
                        ...
                        <td class="left">Ukuran</td>
                         <td class="right">Quantity Tercatat</td>
                         <td class="right">Quantity Tersedia</td>
                  ...
                  <tbody id="product-row<?php echo $product_row; ?>">
                    <tr>
                        ...
                        <td class="left"><input type="text" data-id="<?php echo $product_row; ?>" class="product-name" name="product[<?php echo $product_row ?>][name]" value="<?php echo $product['name'] ?>" />
                            ...
                            <input type="hidden" class="nilaibarang" name="product[<?php echo $product_row ?>][price]" value="<?php echo $product['price'] ?>" />

                      </td>
                      <td id="option<?php echo $product_row; ?>"></td>
                      <td class="left"><input type="text" name="product[<?php echo $product_row ?>][qtytercatat]" /></td>
                      <td class="left"><input type="text" name="product[<?php echo $product_row ?>][qtytersedia]" /></td>
                      <td class="left"><input type="text" name="product[<?php echo $product_row ?>][keterangan]" /></td>
...
function addModule() {
	...
	html += '    <td class="left"><input type="text" data-id="'+product_row+'" onkeyup="komplit('+product_row+')" class="product-name" name="product[' + product_row + '][name]" /><input type="hidden" name="product[' + product_row + '][product_id]" /><input type="hidden" name="product[' + product_row + '][price]" /></td>';
	html += '    <td class="left" id="option'+product_row+'"></td>';
	html += '    <td class="right"><select name="product[' + product_row + '][qtytercatat]" /></select></td>';
  html += '    <td class="right"><select name="product[' + product_row + '][qtytersedia]" /></select></td>';
        html += '    <td class="right"><input type="text" name="product[' + product_row + '][keterangan]" /></td>';
    ...
    //alert(JSON.stringify(ui));
      var column=$(this).data("id");
        ...
        if(option_value['qty'] >= 1){
          ...
          html += '    <td class="left">'+ui.item['label']+'<input type="hidden" name="product[' + coba+ '][product_id]" value="'+ui.item['value']+'" /><<input type="hidden" name="product[' + coba+ '][price]" value="'+ui.item['price']+'" /></td>';
          ...
          html += '    <td class="right">'+ui.item['qty']+'<input type="hidden" name="product[' + coba+ '][qtytercatat]" value="'+ui.item['qty']+'" /></td>';
          html += '    <td class="right">'+ui.item['qty']+'<input type="text" name="product[' + coba+ '][qtytersedia]" value="" /></td>';
          html += '    <td class="right"><input type="text" name="product[' + coba + '][keterangan]" value="'+ui.item['keterangan']+'" /></td>';
      ...
      $("input[name='product["+coba+"][qtytercatat]']").remove();
