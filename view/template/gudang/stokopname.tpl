        ...
        <div class="box">
          ...
          <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <tr>
                  <td>Tanggal Mulai
                    <input class="form-control" type="text" name="filter_date_start" value="<?php echo $filter_date_start; ?>" id="date-start" size="12" readonly /></td>
                  <td>Tanggal Selesai
                    <input class="form-control" type="text" name="filter_date_end" value="<?php echo $filter_date_end; ?>" id="date-end" size="12" readonly /></td>
                   ...
                   <td>Product Name
                    <input class="form-control" type="text" name="filter_product_name" />
                    <input class="form-control" type="hidden" name="filter_product_id" />
                  </td>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td class="left"><?php echo $product['qtytercatat']; ?></td>
                      <td class="left"><?php echo $product['qtyrusak']; ?></td>
                       <td class="left"><?php echo $product['qtyhilang']; ?></td>
                        <td class="left"><?php echo $product['qtytersedia']- ($product['qtytercatat'] - ($product['qtyrusak']+$product['qtyhilang'])); ?></td>
                      <td class="right"><?php echo $product['qtytersedia']; ?></td>
                      <td class="left"><?php echo ($product['qtytersedia'] -($product['qtytercatat'] - ($product['qtyrusak']+$product['qtyhilang']))); ?></td>
                    </tr>
                    <?php
...
function filter() {
	url = 'index.php?route=gudang/stokopname&token=<?php echo $token; ?>';
