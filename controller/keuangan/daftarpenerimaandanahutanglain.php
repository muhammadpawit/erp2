<?php
class ControllerKeuanganDaftarPenerimaandanaHutangLain extends Controller {
	private $error=array();
	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				'text' => 'Tampil',
				'href' => $this->url->link('keuangan/daftarpenerimaandanahutanglain/tampil', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].$url, 'SSL')
			);
			if(!empty($result['ref'])){
		...
		$pagination->url = $this->url->link('keuangan/daftarpenerimaandanahutanglain', 'token=' . $this->session->data['token'] . $url . '&page={page}');
	...
	//	$this->data['gudangasals']=$this->model_catalog_gudang->getGudangs(true);
		...
		$this->template = 'keuangan/daftarpenerimaandanahutanglain.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function tampil(){
		...
		if(isset($this->request->get['id'])){
			if(!empty($this->request->get['id'])){
				...
				$this->redirect($this->url->link('keuangan/daftarpenerimaandanahutanglain', 'token=' . $this->session->data['token'] . $url, 'SSL'));
			}
		}else{
			$this->redirect($this->url->link('keuangan/daftarpenerimaandanahutanglain', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
		...
		$this->data['cancel']= $this->url->link('keuangan/daftarpenerimaandanahutanglain', 'token=' . $this->session->data['token'] . $url, 'SSL');
