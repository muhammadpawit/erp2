				...
				$datalabarugi=$p;
				    ...
				    foreach($pendapatan as $d){
				      ...
				      $kreditawal=$this->model_keuangan_jurnal->totalKredit($d['kode_rek'],$filterawal);
						...
						$debettahunsebelumnya=0;
						$kredittahunsebelumnya=0;
						if($tahun[0] > 2018){
							$debettahunsebelumnya=$this->model_keuangan_jurnal->totalDebet($d['kode_rek'],$filtertahunsebelumnya);
							$kredittahunsebelumnya=$this->model_keuangan_jurnal->totalKredit($d['kode_rek'],$filtertahunsebelumnya);
						}
						//$saldopendapatanawal += ($kredittahunsebelumnya - $debettahunsebelumnya);
						$saldopendapatanawal=($kreditawal-$debetawal)+($kredittahunsebelumnya - $debettahunsebelumnya);
						...
						$filtertahunakhirsebelumnya=array(
							'filter_date_start'	=> '2018-03-01',
							'filter_date_end'	=> ($tahun2[0]-1).'-12-31'
						);
						$debetakhirtahunsebelumnya=0;
						$kreditakhirtahunsebelumnya=0;

						if($tahun2[0] > 2018){
							$debetakhirtahunsebelumnya=$this->model_keuangan_jurnal->totalDebet($d['kode_rek'],$filtertahunakhirsebelumnya);
							$kreditakhirtahunsebelumnya=$this->model_keuangan_jurnal->totalKredit($d['kode_rek'],$filtertahunakhirsebelumnya);
						}
				      $saldopendapatanakhir=($kreditakhir-$debetakhir)+($kreditakhirtahunsebelumnya-$debetakhirtahunsebelumnya);
				    ...
				    foreach($hpp as $d){
				      ...
				      $saldohppawal=($debetawal-$kreditawal)+($debettahunsebelumnya-$kredittahunsebelumnya);
					...
					if($tahun2[0] > 2018){
				      ...
				      $saldohppakhir=($debetakhir-$kreditakhir)+($debetakhirtahunsebelumnya-$kreditakhirtahunsebelumnya);
				    ...
				    foreach($biaya as $d){
				      ...
				      $saldobiayaawal=($debetawal-$kreditawal)+($debettahunsebelumnya-$kredittahunsebelumnya);
					...
					if($tahun2[0] > 2018){
				      ...
				      $saldobiayaakhir=($debetakhir-$kreditakhir)+($debetakhirtahunsebelumnya-$kreditakhirtahunsebelumnya);
				    ...
				    foreach($biayalain as $d){
				      ...
				      $saldobiayalainawal=($kreditawal-$debetawal)+($kredittahunsebelumnya-$debettahunsebelumnya);
					...
					if($tahun2[0] > 2018){
				      ...
				      $saldobiayalainakhir=($kreditakhir-$debetakhir)+($kreditakhirtahunsebelumnya-$debetakhirtahunsebelumnya);
					...
					foreach($pendapatanlain as $d){
				      ...
				      $saldopendapatanlainawal=($debetawal-$kreditawal)+($debettahunsebelumnya-$kredittahunsebelumnya);
					...
					if($tahun2[0] > 2018){
				      ...
				      $saldopendapatanlainakhir=($debetakhir-$kreditakhir)+($debetakhirtahunsebelumnya-$kreditakhirtahunsebelumnya);
					...
					foreach($pendapatanluarbiasa as $d){
				      ...
				      $saldopendapatanluarbiasaawal=($kreditawal-$debetawal)+($kredittahunsebelumnya-$debettahunsebelumnya);
					...
					if($tahun2[0] > 2018){
				      ...
				      $saldopendapatanluarbiasaakhir=($kreditakhir-$debetakhir)+($kreditakhirtahunsebelumnya-$debetakhirtahunsebelumnya);
