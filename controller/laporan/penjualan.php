<?php
class ControllerLaporanPenjualan extends Controller {
	private $error = array();
  ...
  /*      if (isset($this->request->get['filter_qty'])) {
   	...
   	if (isset($this->session->data['success'])) {
		...
		$pagination->url = $this->url->link('laporan/penjualan', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'laporan/penjualan.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
