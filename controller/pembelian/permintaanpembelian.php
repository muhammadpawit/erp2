<?php
class ControllerPembelianPermintaanpembelian extends Controller {
	private $error=array();
	public function index() {
		...
		$this->data['insert'] = $this->url->link('pembelian/permintaanpembelian/insert', 'token=' . $this->session->data['token'].$url, 'SSL');
      ...
      'permintaan_pembelian.status'			=> $filter_status,
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				'text' => 'Tampil',
				'href' => $this->url->link('pembelian/permintaanpembelian/tampil', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].$url, 'SSL')
			);
			$action[] = array(
				'text' => 'Cetak',
				'href' => $this->url->link('pembelian/permintaanpembelian/cetak', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].$url, 'SSL')
			);
			...
			if($result['status'] == 1){
				...
				$action[] = array(
					'text' => 'Batalkan',
					'href' => $this->url->link('pembelian/permintaanpembelian/batalkan', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].$url, 'SSL')
				);
				$action[] = array(
					'text' => 'Setujui',
					'href' => $this->url->link('pembelian/permintaanpembelian/setujui', 'token=' . $this->session->data['token'] . '&id=' . $result['id'].$url, 'SSL')
				);
			}
		...
		$pagination->url = $this->url->link('pembelian/permintaanpembelian', 'token=' . $this->session->data['token'] . $url . '&page={page}');
	...
	//	$this->data['gudangasals']=$this->model_catalog_gudang->getGudangs(true);
		...
		$this->template = 'pembelian/permintaanpembelian.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function insert() {
      ...
      $no_surat=$this->model_pembelian_permintaanpembelian->addPermintaanPembelian($this->request->post);
		...
		$this->data['action']= $this->url->link('pembelian/permintaanpembelian/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->template = 'pembelian/permintaanpembelian_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	//	print_r($prods);
		...
		$this->template = 'pembelian/permintaanpembelian_info.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
