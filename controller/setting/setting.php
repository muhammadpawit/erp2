...
*/
  ...
  if (isset($this->session->data['success'])) {
		...
		if (isset($this->request->post['config_printer'])) {
			$this->data['config_printer'] = $this->request->post['config_printer'];
		} else {
			$this->data['config_printer'] = $this->config->get('config_printer');
		}

		if (isset($this->request->post['config_printer_status'])) {
			$this->data['config_printer_status'] = $this->request->post['config_printer_status'];
		} else {
			$this->data['config_printer_status'] = $this->config->get('config_printer_status');
		}

		if (isset($this->request->post['config_jam_masuk'])) {
			$this->data['config_jam_masuk'] = $this->request->post['config_jam_masuk'];
		} else {
			$this->data['config_jam_masuk'] = $this->config->get('config_jam_masuk');
		}

		if (isset($this->request->post['config_jam_pulang'])) {
			$this->data['config_jam_pulang'] = $this->request->post['config_jam_pulang'];
		} else {
			$this->data['config_jam_pulang'] = $this->config->get('config_jam_pulang');
		}
...
*/
	...
	public function template() {
        // tokocepat
		if (file_exists(DIR_IMAGE . 'templates/' . basename($this->request->get['template']) . '.jpg')) {
			$image = HTTPS_IMAGE . 'templates/' . basename($this->request->get['template']) . '.jpg';
		} else {
