<?php
class ControllerCatalogOptions extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('catalog/category');

		$this->document->setTitle('Master Data Ukuran Tabung');
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->session->data['success'] = 'Data Ukuran Tabung berhasil ditambahkan.';
			$url = '';
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->session->data['success'] = 'Data Ukuran Tabung berhasil diperbarui';
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->session->data['success'] = 'Data Ukuran Tabung berhasil dihapus';
	...
	private function validateForm() {
		/*if (!$this->user->hasPermission('modify', 'catalog/options')) {
			$this->error['warning'] = 'Anda tidak memiliki hak untuk memodifikasi menu Ukuran Tabung';
		}*/
